...
export const default_variables: Theme_Variable[] = [
	...
	{name: 'color_b_5', light: 'hsl(var(--hue_b), 55%, 36%)'},
	...
	{name: 'color_e_2', light: 'hsl(var(--hue_e), 80%, 81%)'},
	{name: 'color_e_3', light: 'hsl(var(--hue_e), 75%, 72%)'},
	{name: 'color_e_4', light: 'hsl(var(--hue_e), 70%, 60%)'},
	{name: 'color_e_5', light: 'hsl(var(--hue_e), 70%, 48%)'},
	{name: 'color_e_6', light: 'hsl(var(--hue_e), 70%, 38%)'},
	{name: 'color_e_7', light: 'hsl(var(--hue_e), 75%, 30%)'},
	{name: 'color_e_8', light: 'hsl(var(--hue_e), 80%, 20%)'},
	...
	{name: 'color_f_9', light: 'hsl(var(--hue_f), 77%, 6%)'},
