...
export const default_variables: Theme_Variable[] = [
	...
	{name: 'color_b_1', light: 'hsl(var(--hue_b), 55%, 92%)'},
	{name: 'color_b_2', light: 'hsl(var(--hue_b), 55%, 79%)'},
	{name: 'color_b_3', light: 'hsl(var(--hue_b), 55%, 64%)'},
	{name: 'color_b_4', light: 'hsl(var(--hue_b), 55%, 50%)'},
	{name: 'color_b_5', light: 'hsl(var(--hue_b), 55%, 35%)'},
	{name: 'color_b_6', light: 'hsl(var(--hue_b), 55%, 25%)'},
	...
	{name: 'color_f_1', light: 'hsl(var(--hue_f), 27%, 83%)'},
	{name: 'color_f_2', light: 'hsl(var(--hue_f), 27%, 69%)'},
	{name: 'color_f_3', light: 'hsl(var(--hue_f), 27%, 56%)'},
	{name: 'color_f_4', light: 'hsl(var(--hue_f), 37%, 38%)'},
	{name: 'color_f_5', light: 'hsl(var(--hue_f), 57%, 24%)'},
	{name: 'color_f_6', light: 'hsl(var(--hue_f), 62%, 18%)'},
	{name: 'color_f_7', light: 'hsl(var(--hue_f), 67%, 14%)'},
	{name: 'color_f_8', light: 'hsl(var(--hue_f), 72%, 10%)'},
	{name: 'color_f_9', light: 'hsl(var(--hue_f), 77%, 7%)'},
