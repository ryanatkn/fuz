...
export const default_variables: Theme_Variable[] = [
	...
	{name: 'color_a', light: 'var(--color_a_5)', dark: 'var(--color_a_3)'},
	{name: 'color_a_1', light: 'hsl(var(--hue_a), 55%, 95%)'},
	{name: 'color_a_2', light: 'hsl(var(--hue_a), 55%, 85%)'},
	{name: 'color_a_3', light: 'hsl(var(--hue_a), 55%, 75%)'},
	{name: 'color_a_4', light: 'hsl(var(--hue_a), 55%, 62%)'},
	{name: 'color_a_5', light: 'hsl(var(--hue_a), 55%, 50%)'},
	...
	{name: 'color_b', light: 'var(--color_b_5)', dark: 'var(--color_b_3)'},
	{name: 'color_b_1', light: 'hsl(var(--hue_b), 55%, 95%)'},
	{name: 'color_b_2', light: 'hsl(var(--hue_b), 55%, 85%)'},
	{name: 'color_b_3', light: 'hsl(var(--hue_b), 55%, 75%)'},
	{name: 'color_b_4', light: 'hsl(var(--hue_b), 55%, 62%)'},
	{name: 'color_b_5', light: 'hsl(var(--hue_b), 55%, 32%)'},
	{name: 'color_b_6', light: 'hsl(var(--hue_b), 55%, 24%)'},
	{name: 'color_b_7', light: 'hsl(var(--hue_b), 55%, 16%)'},
	{name: 'color_b_8', light: 'hsl(var(--hue_b), 55%, 10%)'},
	{name: 'color_b_9', light: 'hsl(var(--hue_b), 55%, 4%)'},
	{name: 'color_c', light: 'var(--color_c_5)', dark: 'var(--color_c_4)'}, // TODO 4 not 3?
	{name: 'color_c_1', light: 'hsl(var(--hue_c), 60%, 92%)'},
	{name: 'color_c_2', light: 'hsl(var(--hue_c), 60%, 82%)'},
	{name: 'color_c_3', light: 'hsl(var(--hue_c), 60%, 73%)'},
	{name: 'color_c_4', light: 'hsl(var(--hue_c), 60%, 63%)'},
	{name: 'color_c_5', light: 'hsl(var(--hue_c), 60%, 50%)'},
	{name: 'color_c_6', light: 'hsl(var(--hue_c), 60%, 40%)'},
	{name: 'color_c_7', light: 'hsl(var(--hue_c), 60%, 30%)'},
	{name: 'color_c_8', light: 'hsl(var(--hue_c), 60%, 20%)'},
	{name: 'color_c_9', light: 'hsl(var(--hue_c), 60%, 10%)'},
	{name: 'color_d', light: 'var(--color_d_5)', dark: 'var(--color_d_3)'},
	{name: 'color_d_1', light: 'hsl(var(--hue_d), 50%, 95%)'},
	{name: 'color_d_2', light: 'hsl(var(--hue_d), 50%, 85%)'},
	{name: 'color_d_3', light: 'hsl(var(--hue_d), 50%, 75%)'},
	{name: 'color_d_4', light: 'hsl(var(--hue_d), 50%, 62%)'},
	{name: 'color_d_5', light: 'hsl(var(--hue_d), 50%, 50%)'},
	...
	{name: 'color_e', light: 'var(--color_e_5)', dark: 'var(--color_e_3)'},
	{name: 'color_e_1', light: 'hsl(var(--hue_e), 75%, 90%)'},
	{name: 'color_e_2', light: 'hsl(var(--hue_e), 70%, 81%)'},
	{name: 'color_e_3', light: 'hsl(var(--hue_e), 65%, 72%)'},
	{name: 'color_e_4', light: 'hsl(var(--hue_e), 60%, 62%)'},
	{name: 'color_e_5', light: 'hsl(var(--hue_e), 55%, 50%)'},
	{name: 'color_e_6', light: 'hsl(var(--hue_e), 65%, 40%)'},
	{name: 'color_e_7', light: 'hsl(var(--hue_e), 75%, 30%)'},
	{name: 'color_e_8', light: 'hsl(var(--hue_e), 85%, 20%)'},
	{name: 'color_e_9', light: 'hsl(var(--hue_e), 95%, 10%)'},
	{name: 'color_f', light: 'var(--color_f_5)', dark: 'var(--color_f_3)'},
	{name: 'color_f_1', light: 'hsl(var(--hue_f), 27%, 82%)'},
	{name: 'color_f_2', light: 'hsl(var(--hue_f), 27%, 68%)'},
	{name: 'color_f_3', light: 'hsl(var(--hue_f), 27%, 55%)'},
	{name: 'color_f_4', light: 'hsl(var(--hue_f), 37%, 37%)'},
	{name: 'color_f_5', light: 'hsl(var(--hue_f), 57%, 22%)'},
	{name: 'color_f_6', light: 'hsl(var(--hue_f), 62%, 16%)'},
	{name: 'color_f_7', light: 'hsl(var(--hue_f), 67%, 12%)'},
	{name: 'color_f_8', light: 'hsl(var(--hue_f), 72%, 8%)'},
	{name: 'color_f_9', light: 'hsl(var(--hue_f), 77%, 4%)'},
	{name: 'color_g', light: 'var(--color_g_5)', dark: 'var(--color_g_3)'},
	{name: 'color_g_1', light: 'hsl(var(--hue_g), 74%, 95%)'},
	{name: 'color_g_2', light: 'hsl(var(--hue_g), 74%, 86%)'},
	{name: 'color_g_3', light: 'hsl(var(--hue_g), 74%, 76%)'},
	{name: 'color_g_4', light: 'hsl(var(--hue_g), 74%, 66%)'},
	{name: 'color_g_5', light: 'hsl(var(--hue_g), 74%, 56%)'},
