...
export const default_variables: Theme_Variable[] = [
	...
	{name: 'color_c_1', light: 'hsl(var(--hue_c), 50%, 95%)'},
	{name: 'color_c_2', light: 'hsl(var(--hue_c), 50%, 85%)'},
	{name: 'color_c_3', light: 'hsl(var(--hue_c), 50%, 75%)'},
	{name: 'color_c_4', light: 'hsl(var(--hue_c), 50%, 63%)'},
	{name: 'color_c_5', light: 'hsl(var(--hue_c), 50%, 50%)'},
	{name: 'color_c_6', light: 'hsl(var(--hue_c), 50%, 40%)'},
	{name: 'color_c_7', light: 'hsl(var(--hue_c), 50%, 30%)'},
	{name: 'color_c_8', light: 'hsl(var(--hue_c), 50%, 20%)'},
	{name: 'color_c_9', light: 'hsl(var(--hue_c), 50%, 10%)'},
	...
	{name: 'color_e_1', light: 'hsl(var(--hue_e), 55%, 95%)'},
	{name: 'color_e_2', light: 'hsl(var(--hue_e), 55%, 85%)'},
	{name: 'color_e_3', light: 'hsl(var(--hue_e), 55%, 75%)'},
	{name: 'color_e_4', light: 'hsl(var(--hue_e), 55%, 62%)'},
	{name: 'color_e_5', light: 'hsl(var(--hue_e), 55%, 50%)'},
	{name: 'color_e_6', light: 'hsl(var(--hue_e), 55%, 40%)'},
	{name: 'color_e_7', light: 'hsl(var(--hue_e), 55%, 30%)'},
	{name: 'color_e_8', light: 'hsl(var(--hue_e), 55%, 20%)'},
	{name: 'color_e_9', light: 'hsl(var(--hue_e), 55%, 10%)'},
	{name: 'color_f', light: 'var(--color_f_5)', dark: 'var(--color_f_3)'},
	{name: 'color_f_1', light: 'hsl(var(--hue_f), 97%, 95%)'},
	{name: 'color_f_2', light: 'hsl(var(--hue_f), 97%, 85%)'},
	{name: 'color_f_3', light: 'hsl(var(--hue_f), 97%, 75%)'},
	{name: 'color_f_4', light: 'hsl(var(--hue_f), 97%, 62%)'},
	{name: 'color_f_5', light: 'hsl(var(--hue_f), 97%, 22%)'},
	{name: 'color_f_6', light: 'hsl(var(--hue_f), 97%, 16%)'},
	{name: 'color_f_7', light: 'hsl(var(--hue_f), 97%, 11%)'},
	{name: 'color_f_8', light: 'hsl(var(--hue_f), 97%, 6%)'},
	{name: 'color_f_9', light: 'hsl(var(--hue_f), 97%, 2%)'},
