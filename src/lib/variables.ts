...
export const default_variables: Theme_Variable[] = [
	...
	*/
	...
	{name: 'space_1', light: '1.6rem'},
	{name: 'space_2', light: '2.1rem'},
	{name: 'space_3', light: '2.6rem'},
	{name: 'space_4', light: '3.3rem'},
	{name: 'space_5', light: '4.2rem'},
	{name: 'space_6', light: '5.4rem'},
	{name: 'space_7', light: '6.9rem'},
	{name: 'space_8', light: '8.7rem'},
	{name: 'space_9', light: '11.1rem'},
	...
	{name: 'input_height', light: 'var(--space_5)'},
	{name: 'input_height_sm', light: 'var(--space_4)'},
	{
