...
import {create_test_source, TEST_SOURCES, assert_source_in_directive, assert_source_not_in_directive} from '$lib/csp_test_helpers.js';

const {TRUSTED, TRUSTED_2, TRUSTED_A} = TEST_SOURCES;

// ============================================================================
// is_csp_trusted tests
// ============================================================================
...
// ============================================================================
// required_trust_defaults option tests
// ============================================================================
...
test('required_trust_defaults: null prevents trusted sources from being added', () => {
	...
	assert_source_in_directive(csp, 'script-src', TRUSTED, 'script-src should still include trusted source');
});

// ============================================================================
// required_trust_defaults_base option tests
// ============================================================================
...
test('required_trust_defaults_base: can provide custom trust requirements', () => {
	...
	assert_source_in_directive(csp, 'script-src', TRUSTED_2, 'script-src should include medium trust source');

	// Both sources should be in connect-src since requirement is low
	assert_source_in_directive(csp, 'connect-src', TRUSTED, 'connect-src should include low trust source');
	assert_source_in_directive(csp, 'connect-src', TRUSTED_2, 'connect-src should include medium trust source');
