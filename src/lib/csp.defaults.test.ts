...
import {create_test_source, TEST_SOURCES, assert_directive_exists, assert_directive_not_exists, assert_source_in_directive} from '$lib/csp_test_helpers.js';

const {DEFAULT_OVERRIDE, SECONDARY_DEFAULT, TRUSTED} = TEST_SOURCES;

// ============================================================================
// value_defaults option tests
// ============================================================================
...
test('value_defaults: works with trusted sources', () => {
	...
	assert_source_in_directive(csp, 'img-src', TRUSTED, 'trusted source should be added to default');
	assert_source_in_directive(csp, 'connect-src', DEFAULT_OVERRIDE, 'default value should be present');
	assert_source_in_directive(csp, 'connect-src', TRUSTED, 'trusted source should be added to default');
});
...
test('value_defaults: multiple defaults combined', () => {
	...
	assert_source_in_directive(csp, 'img-src', DEFAULT_OVERRIDE, 'img-src should have first default value');
	...
	assert_source_in_directive(csp, 'script-src', DEFAULT_OVERRIDE, 'script-src should have default value');
	assert_source_in_directive(csp, 'script-src', TRUSTED, 'script-src should have trusted source');
});

// ============================================================================
// value_defaults_base option tests
// ============================================================================
...
// ============================================================================
// Default value mutation doesn't affect subsequent calls
// ============================================================================
