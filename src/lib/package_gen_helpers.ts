...
export const package_gen_generate_ts = (package_json: PackageJson, src_json: SrcJson): string => {
	...
	// eslint-disable no-useless-escape because json_embed creates `\"` inside single-quoted strings
	// which is necessary for JSON.parse but ESLint doesn't understand that context
	return `// generated by package.gen.ts -- do not edit directly or risk lost data
...
export const package_json: PackageJson = ${json_embed(package_json, stringify)};

export const src_json: SrcJson = ${json_embed(src_json, stringify)};
`;
};
