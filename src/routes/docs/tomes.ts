...
import PendingAnimation from '$routes/docs/pending_animation/+page.svelte';
import PendingButton from '$routes/docs/pending_button/+page.svelte';
import PackageSummary from '$routes/docs/package_summary/+page.svelte';
import PackageDetail from '$routes/docs/package_detail/+page.svelte';
...
import HueInput from '$routes/docs/hue_input/+page.svelte';
