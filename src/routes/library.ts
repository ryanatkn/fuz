...
import {library_json_parse} from '@ryanatkn/belt/library_json.js';
...
export const source_json: SourceJson = {
	...
	modules: [
		...
		},
		{
			...
			dependencies: ['DeclarationDetail.svelte', 'TomeSection.svelte', 'TomeSectionHeader.svelte'],
			dependents: ['ApiIndex.svelte', 'ApiModule.svelte'],
		},
		{
		...
		},
		{
			...
			declarations: [
				...
				},
				{
					...
					kind: 'function',
					doc_comment: 'Generate the library.ts file content with library_json export.',
					source_line: 106,
					type_signature:
