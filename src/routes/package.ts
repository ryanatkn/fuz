		...
		'./ts_helpers.ts': {
			...
			declarations: [
				...
				},
				{
					...
					type_signature:
						'(node: Node, source_file: SourceFile): { full_text: string; summary: string; examples: string[]; deprecated?: string | undefined; see_also: string[]; } | undefined',
					return_type:
				...
				},
				{
					...
					type_signature:
						'(node: Node, symbol: Symbol, checker: TypeChecker, enhanced: Enhanced_Declaration, jsdoc: { full_text: string; summary: string; examples: string[]; deprecated?: string | undefined; see_also: string[]; } | undefined): void',
					return_type: 'void',
					parameters: [
						{
							name: 'node',
		...
		'./enhanced_declarations.ts': {
			...
			declarations: [
				...
				},
				{
					...
					type_signature:
						'(decl: Enhanced_Declaration | { [x: string]: unknown; name: string; kind: "function" | "type" | "variable" | "class" | "component" | "json" | "css" | null; }): decl is Enhanced_Declaration',
					return_type: 'boolean',
					parameters: [
						{
							name: 'decl',
							type: 'Enhanced_Declaration | { [x: string]: unknown; name: string; kind: "function" | "type" | "variable" | "class" | "component" | "json" | "css" | null; }',
							optional: false,
						},
					],
					exported: false,
