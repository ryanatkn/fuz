...
Fuz is being made to support other projects that focus on end-users
with emphasis on capability and efficiency.
It's not trying to be as generalized as most UI libraries.
