...
`.trim()},i=(t,e=!1,a=!0)=>{const s=e?t.dark:t.light;return s?"--"+t.name+": "+s+";"+(a&&t.summary?" /* "+t.summary+" */":""):""},g=Symbol("theme"),K=()=>_(g),R=t=>h(g,t),f=Symbol("color_scheme"),Y=()=>_(f),j=t=>h(f,t);export{p as D,Y as a,j as b,y as c,d,T as e,C as f,K as g,O as h,I as i,x as j,M as k,L as l,H as r,R as s};
