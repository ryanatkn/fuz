import{a as e,t as d,g as D}from"../chunks/disclose-version.DkCpnmWz.js";import{p as F,f as m,a as G,s as r,c as b,a4 as o,r as C}from"../chunks/runtime.BsoL6_G0.js";import{b as P}from"../chunks/entry.Cm3CMHB9.js";import{C as c}from"../chunks/Code.DDrBXyxH.js";import{g as J}from"../chunks/tome.C1LBsZpm.js";import{C as v}from"../chunks/Card.BeP8sba1.js";import{T as K}from"../chunks/Tome_Content.zFEywe-m.js";import{T as u,a as g}from"../chunks/Tome_Section_Header.BfSAVFU2.js";var O=d("just<br> a card",1),Q=d("custom<br> icon",1),U=d("<!> <!> <!>",1),V=d("a<br> link",1),X=d("<!> <!> <!>",1),Z=d("href is<br> selected",1),rr=d("<!> <!> <!>",1),tr=d("custom<br> tag",1),or=d("<!> <!> <!>",1),ar=d("align<br> icon right",1),er=d("<!> <!> <!>",1),nr=d("align<br> icon above",1),sr=d("align<br> icon below",1),dr=d("<section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function pr(j,B){F(B,!0);const H=J("Card"),x=`${P}/library`;K(j,{tome:H,children:(N,ir)=>{var T=dr(),p=m(T),A=b(p);c(A,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var k=r(A,2);c(k,{content:`<Card>
  just<br />
  a card
