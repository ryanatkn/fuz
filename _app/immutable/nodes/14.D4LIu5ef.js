...
`;var Ro=$("<!> <!>",1),Do=$('<div class="cat_wrapper svelte-ki3ktl"><!></div>'),Fo=$('<div class="position home svelte-ki3ktl"><div class="icon svelte-ki3ktl">🏠</div> <div class="cats svelte-ki3ktl"></div></div>'),Mo=$('<div class="cat_wrapper svelte-ki3ktl"><!></div>'),Lo=$('<div class="position adventure svelte-ki3ktl"><div class="icon svelte-ki3ktl">🌄</div> <div class="cats svelte-ki3ktl"></div></div>'),Uo=$('<section class="display_flex"><div><!> <!></div></section> <section><!></section>',1),Ho=$("<!> <!>",1),qo=$('<div class="mx_auto box"><div class="pane p_xl text_align_center"><h1>About Fuz</h1> <blockquote>Svelte UI library</blockquote> <blockquote>free and open source at<br/><a href="https://github.com/ryanatkn/fuz">github.com/ryanatkn/fuz</a></blockquote> <code class="display_block p_md mb_lg">npm i -D <a href="https://www.npmjs.com/package/@fuz.dev/fuz_contextmenu">@fuz.dev/fuz_contextmenu</a></code> <div class="p_xl box"><h2>Color scheme</h2> <!> <h2>Theme</h2> <!></div></div></div>'),Bo=$("<!> <!>",1);function Wo(s,t){yt(t,!0);const n=Mt.get(),c=P(()=>n.component),_="Alyssa",i="Ben",u="home";let l=D(u),v=D(u);const f=P(()=>e(l)===e(v)?"😺":"😾"),M=P(()=>e(l)===e(v)?"😸":"😿"),A=P(()=>({name:_,icon:e(f),position:e(l)})),p=P(()=>({name:i,icon:e(M),position:e(v)}));let g=D(!1);const x=(N,G)=>{const et=[],K=[];for(const U of N){const st=U.position==="home"?et:K;G?st.unshift(U):st.push(U)}return{home_cats:et,adventure_cats:K}},w=P(()=>x([e(A),e(p)],e(g))),k=P(()=>e(w).home_cats),h=P(()=>e(w).adventure_cats),C=P(()=>e(l)!==u||e(v)!==u),X=()=>{a(l,u),a(v,u)};let Q=D(!1);const I=()=>{a(Q,!e(Q))},O=N=>{switch(N.type){case"call_cats_adventure":{a(l,"adventure"),a(v,"adventure");break}case"call_cats_home":{a(l,"home"),a(v,"home");break}case"cat_go_adventure":{N.name===_?a(l,"adventure"):N.name===i&&a(v,"adventure");break}case"cat_go_home":{N.name===_?a(l,"home"):N.name===i&&a(v,"home");break}case"cat_be_or_do":{a(g,!e(g));break}}},[E,R]=gn({fallback:(N,G)=>{const et=window.getComputedStyle(N),K=et.transform==="none"?"":et.transform;return{duration:1500,easing:ho,css:U=>`
					transform: ${K} scale(${U});
					opacity: ${U}
				`}}});var b=Bo(),H=S(b);Bt(H,()=>e(c),(N,G)=>{G(N,{scoped:!0,children:(et,K)=>{Dt(et,{children:(U,st)=>{var ct=Ho(),it=S(ct);Ft(it,{text:"Full example"});var xt=r(it,2);At(xt,{entries:bt=>{var L=Ro(),j=S(L);{var J=Y=>{Ee(Y,{run:X,content:"Reset",icon:"↻"})};Z(j,Y=>{e(C)&&Y(J)})}var W=r(j,2);wo(W,{toggle_about_dialog:I}),o(bt,L)},children:(bt,L)=>{var j=Uo(),J=S(j),W=m(J),Y=m(W);At(Y,{entries:at=>{To(at,{act:O,get home_cats(){return e(k)},get adventure_cats(){return e(h)}})},children:(at,kt)=>{var vt=Fo(),It=r(m(vt),2);Vt(It,29,()=>e(k),({name:T,icon:q,position:V})=>T,(T,q)=>{let V=()=>e(q).name,rt=()=>e(q).icon,nt=()=>e(q).position;var mt=Do(),Ct=m(mt);At(Ct,{entries:Et=>{ve(Et,{act:O,get name(){return V()},get icon(){return rt()},get position(){return nt()}})},children:(Et,Ot)=>{Me(Et,{get name(){return V()},get icon(){return rt()}})},$$slots:{entries:!0,default:!0}}),d(mt),ee(1,mt,()=>R,()=>({key:V()})),ee(2,mt,()=>E,()=>({key:V()})),Re(mt,()=>Fe,null),o(T,mt)}),d(It),d(vt),o(at,vt)},$$slots:{entries:!0,default:!0}});var pt=r(Y,2);At(pt,{entries:at=>{Io(at,{act:O,get home_cats(){return e(k)},get adventure_cats(){return e(h)}})},children:(at,kt)=>{var vt=Lo(),It=r(m(vt),2);Vt(It,29,()=>e(h),({name:T,icon:q,position:V})=>T,(T,q)=>{let V=()=>e(q).name,rt=()=>e(q).icon,nt=()=>e(q).position;var mt=Mo(),Ct=m(mt);At(Ct,{entries:Et=>{ve(Et,{act:O,get name(){return V()},get icon(){return rt()},get position(){return nt()}})},children:(Et,Ot)=>{Me(Et,{get name(){return V()},get icon(){return rt()}})},$$slots:{entries:!0,default:!0}}),d(mt),ee(1,mt,()=>R,()=>({key:V()})),ee(2,mt,()=>E,()=>({key:V()})),Re(mt,()=>Fe,null),o(T,mt)}),d(It),d(vt),o(at,vt)},$$slots:{entries:!0,default:!0}}),d(W),d(J);var ut=r(J,2),Lt=m(ut);He(Lt,{summary:at=>{F();var kt=B("View example source");o(at,kt)},children:(at,kt)=>{qt(at,{get content(){return No}})},$$slots:{summary:!0,default:!0}}),d(ut),o(bt,j)},$$slots:{entries:!0,default:!0}}),o(U,ct)},$$slots:{default:!0}})},$$slots:{default:!0}})});var y=r(H,2);{var z=N=>{hn(N,{onclose:()=>a(Q,!1),children:(G,et)=>{var K=qo(),U=m(K),st=r(m(U),8),ct=r(m(st),2);wn(ct,{});var it=r(ct,4);$n(it,{}),d(st),d(U),d(K),o(G,K)},$$slots:{default:!0}})};Z(y,N=>{e(Q)&&N(z)})}o(s,b),wt()}var Xo=$("<!> <!> <!>",1),Yo=$(`<div class="panel p_md"><p>Try opening the contextmenu on this panel with rightclick or tap-and-hold.</p> <!> <div><code> </code></div> <div><code> </code></div> <div><code> </code></div> <aside class="mt_lg">The <code>scoped</code> prop is only needed when mounting a contextmenu inside a specific element
					instead of the entire page.</aside></div>`),jo=$("<!> <!>",1);function Vo(s,t){yt(t,!0);const n=Mt.get(),c=P(()=>n.component),_=P(()=>n.name);let i=D(!1),u=D(!1),l=D(!1);var v=tt(),f=S(v);Bt(f,()=>e(c),(M,A)=>{A(M,{scoped:!0,children:(p,g)=>{Dt(p,{children:(x,w)=>{var k=jo(),h=S(k);Ft(h,{text:"Basic usage"});var C=r(h,2);At(C,{entries:Q=>{var I=Xo(),O=S(I);_t(O,{run:()=>void a(i,!e(i)),children:(b,H)=>{F();var y=B("Hello world");o(b,y)},$$slots:{default:!0}});var E=r(O,2);_t(E,{run:()=>void a(u,!e(u)),icon:H=>{F();var y=B("🌞");o(H,y)},children:(H,y)=>{F();var z=B("Hello with an optional icon snippet");o(H,z)},$$slots:{icon:!0,default:!0}});var R=r(E,2);_t(R,{run:()=>void a(l,!e(l)),icon:"🌚",children:(b,H)=>{F();var y=B("Hello with an optional icon string");o(b,y)},$$slots:{default:!0}}),o(Q,I)},children:(Q,I)=>{var O=Yo(),E=r(m(O),2);{let it=P(()=>`<${e(_)} scoped>
  <Contextmenu>
    {#snippet entries()}
...
Try selecting text and then opening the contextmenu on it.`,A=P(()=>e(l)===v||e(l)===f||e(l)===M);var p=tt(),g=S(p);Bt(g,()=>e(c),(x,w)=>{w(x,{get contextmenu(){return _},scoped:!0,children:(k,h)=>{Dt(k,{children:(C,X)=>{var Q=is(),I=S(Q);let O;var E=m(I);Ft(E,{text:"Select text"}),d(I);var R=r(I,2);At(R,{entries:H=>{_t(H,{run:()=>void a(i,!e(i)),children:(y,z)=>{F();var N=B("Toggle something");o(y,N)},$$slots:{default:!0}})},children:(H,y)=>{var z=rs();let N;var G=m(z),et=r(m(G),2),K=r(m(et));K.__click=[as,u];let U;F(),d(et),d(G),Zt(G,Y=>a(u,Y),()=>e(u));var st=r(G,2),ct=m(st);jt(ct),d(st);var it=r(st,2);let xt;var $t=r(it,2),bt=m($t);rn(bt),d($t);var L=r($t,2),j=m(L);ne(j,{path:"Web/HTML/Global_attributes/contenteditable"}),F(),d(L);var J=r(L,4),W=r(J,4);F(2),d(z),lt((Y,pt,ut)=>{N=ft(z,1,"panel p_md",null,N,Y),U=ft(K,1,"",null,U,pt),xt=ft(it,1,"",null,xt,ut)},[()=>({color_g_5:e(A)}),()=>({color_a:e(i)}),()=>({color_g_5:e(A)})]),Ne(ct,()=>e(l),Y=>a(l,Y)),Ne(bt,()=>e(l),Y=>a(l,Y)),Oe("innerText",J,()=>e(l),Y=>a(l,Y)),Oe("innerText",W,()=>e(l),Y=>a(l,Y)),o(H,z)},$$slots:{entries:!0,default:!0}}),lt(b=>O=ft(I,1,"",null,O,b),[()=>({color_d_5:e(A)})]),o(C,Q)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(s,p),wt()}Kt(["click"]);const cs=(s,t)=>{const n=window.getSelection();if(!n||!e(t))return;const c=document.createRange();c.selectNodeContents(e(t)),n.removeAllRanges(),n.addRange(c)};var us=$('<div class="panel p_md mb_lg"><p>Try <button type="button">selecting some text</button> and opening the contextmenu in this panel.</p> <p>Try opening the contextmenu on <a>this link</a>.</p></div>'),ds=$('<li>custom "some custom entry" entry</li>'),_s=$('<li>"copy text" entry when text is selected</li>'),vs=$("<li>link entry when clicking on a link</li>"),ms=$("<p><strong>Expected:</strong> the Fuz contextmenu will open and show:</p> <ul><!> <!> <!></ul>",1),ps=$(`<p><strong>Expected:</strong> no behaviors defined. The system contextmenu will show, bypassing the
			Fuz contextmenu.</p>`),hs=$('<!> <p>Check the boxes below to disable automatic <code>a</code> link detection and <code>copy text</code> detection, and see how the contextmenu behaves.</p> <!> <fieldset><label class="row"><input type="checkbox"/> <span>disable automatic link entries, <code></code></span></label> <label class="row"><input type="checkbox"/> <span>disable automatic copy text entries, <code></code></span></label></fieldset> <!> <p>When no behaviors are defined, the system contextmenu is shown instead.</p> <div class="mb_md"><label class="row"><input type="checkbox"/> include a custom entry, which ensures the Fuz contextmenu is used</label></div> <!>',1);function fs(s,t){yt(t,!0);const n=p=>{var g=us(),x=m(g),w=r(m(x));w.__click=[cs,A];let k;F(),d(x),Zt(x,X=>a(A,X),()=>e(A));var h=r(x,2),C=r(m(h));F(),d(h),d(g),lt((X,Q)=>{k=ft(w,1,"",null,k,X),Ht(C,"href",Q)},[()=>({color_h:e(M)}),()=>kn("/")]),o(p,g)},c=Mt.get(),_=P(()=>c.component),i=P(()=>c.name),u=new oe;let l=D(!1),v=D(!1),f=D(!0),M=D(!1),A=D(void 0);Dt(s,{children:(p,g)=>{var x=hs(),w=S(x);Ft(w,{text:"Disable default behaviors"});var k=r(w,4);{let U=P(()=>`<${e(i)}${e(l)?" link_entry={null}":""}${e(v)?" text_entry={null}":""}>`);qt(k,{get content(){return e(U)}})}var h=r(k,2),C=m(h),X=m(C);jt(X);var Q=r(X,2),I=r(m(Q));I.textContent="link_entry={null}",d(Q),d(C);var O=r(C,2),E=m(O);jt(E);var R=r(E,2),b=r(m(R));b.textContent="text_entry={null}",d(R),d(O),d(h);var H=r(h,2);{let U=P(()=>e(l)?null:void 0),st=P(()=>e(v)?null:void 0);Bt(H,()=>e(_),(ct,it)=>{it(ct,{get contextmenu(){return u},scoped:!0,get link_entry(){return e(U)},get text_entry(){return e(st)},children:(xt,$t)=>{var bt=tt(),L=S(bt);{var j=W=>{At(W,{entries:pt=>{_t(pt,{icon:">",run:()=>void a(M,!e(M)),children:(ut,Lt)=>{F();var Pt=B("some custom entry");o(ut,Pt)},$$slots:{default:!0}})},children:(pt,ut)=>{n(pt)},$$slots:{entries:!0,default:!0}})},J=W=>{n(W)};Z(L,W=>{e(f)?W(j):W(J,!1)})}o(xt,bt)},$$slots:{default:!0}})})}var y=r(H,4),z=m(y),N=m(z);jt(N),F(),d(z),d(y);var G=r(y,2);{var et=U=>{var st=ms(),ct=r(S(st),2),it=m(ct);{var xt=J=>{var W=ds();o(J,W)};Z(it,J=>{e(f)&&J(xt)})}var $t=r(it,2);{var bt=J=>{var W=_s();o(J,W)};Z($t,J=>{e(v)||J(bt)})}var L=r($t,2);{var j=J=>{var W=vs();o(J,W)};Z(L,J=>{e(l)||J(j)})}d(ct),o(U,st)},K=U=>{var st=ps();o(U,st)};Z(G,U=>{e(f)||!e(l)||!e(v)?U(et):U(K,!1)})}ye(X,()=>e(l),U=>a(l,U)),ye(E,()=>e(v),U=>a(v,U)),ye(N,()=>e(f),U=>a(f,U)),o(p,x)},$$slots:{default:!0}}),wt()}Kt(["click"]);var gs=$(`<!> <div class="panel p_md"><!> <p>Opening the contextmenu on <a href="https://www.fuz.dev/">a link like this one</a> has
