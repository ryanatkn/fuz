import{t as v,k as _,a as r}from"../chunks/BVHb_Il8.js";import{p as g,a as y,f as b,s as i,c as a,V as t,r as c}from"../chunks/KxkgHfFn.js";import{C as w}from"../chunks/kRT7KGBF.js";import{g as x}from"../chunks/BSAS3wBa.js";import{T as k}from"../chunks/CzKwTOie.js";import{M as A}from"../chunks/DXOs1df3.js";var C=v(`<section><p>Fuz supports <a href="https://svelte.dev/docs/kit/configuration#csp">SvelteKit's config</a> for <!> with the <code>create_csp_directives</code> helper. Fuz also provides related helpers, types, and CSP data.</p> <p>The goal is to provide a simple trust modeling system that balances safety+security+privacy
			...
			values and trust levels.</aside></section>`,1);function L(n,d){g(d,!0);const l=x("csp");k(n,{tome:l,children:(u,z)=>{var s=C(),o=b(s),e=a(o),p=i(a(e),3);A(p,{path:"https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Content_Security_Policy",children:(h,P)=>{t();var f=_("Content Security Policies");r(h,f)},$$slots:{default:!0}}),t(3),c(e);var m=i(e,10);w(m,{content:`import {create_csp_directives, type Csp_Source_Spec} from '@ryanatkn/fuz/csp.js';
