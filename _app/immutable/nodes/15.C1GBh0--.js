import{t as v,j as _,a as r}from"../chunks/C3a0MWKm.js";import{p as g,a as y,f as b,s as i,Z as a,a3 as t,_ as c}from"../chunks/CBcvYSsl.js";import{C as w}from"../chunks/sas11ncx.js";import{g as x}from"../chunks/Acftajw8.js";import{T as C}from"../chunks/B4IL8Vjp.js";import{M as S}from"../chunks/1FkqCrwq.js";var A=v(`<section><p>Fuz supports <a href="https://svelte.dev/docs/kit/configuration#csp">SvelteKit's config</a> for <!> with the <code>create_csp_directives</code> helper. Fuz also provides related helpers, types, and CSP data.</p> <p>The goal is to provide a simple trust modeling system that balances safety+security+privacy
			...
			values and trust levels.</aside></section>`,1);function L(n,d){g(d,!0);const l=x("csp");C(n,{tome:l,children:(u,z)=>{var s=A(),o=b(s),e=a(o),p=i(a(e),3);S(p,{path:"https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Content_Security_Policy",children:(h,T)=>{t();var f=_("Content Security Policies");r(h,f)},$$slots:{default:!0}}),t(3),c(e);var m=i(e,8);w(m,{content:`import {create_csp_directives, type Csp_Source_Spec} from '@ryanatkn/fuz/csp.js';
