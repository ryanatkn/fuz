import{b as X,a as e,t as n,f as W,s as r,c as s}from"../chunks/disclose-version.COjBdUkA.js";import{p as Z,a as rr}from"../chunks/runtime.BITJpo-a.js";import{b as j}from"../chunks/render.Z7Ne6upu.js";import{i as tr}from"../chunks/lifecycle.DMmtugz9.js";import{b as l}from"../chunks/entry.C42HA4ub.js";import{C as i}from"../chunks/Code.CAGfF-1b.js";import{g as ar}from"../chunks/tome.DbsBumql.js";import{C as d}from"../chunks/Card.ConvOuRT.js";import{T as er}from"../chunks/Tome_Detail.C3wIMBYK.js";import{T as c}from"../chunks/Tome_Subheading.CGRyC0So.js";var or=n("just<br> a card",1),nr=n("📖",1),ir=n("custom<br> icon",1),sr=n("a<br> link",1),dr=n("href is<br> selected",1),cr=n("custom<br> tag",1),lr=n("align<br> icon right",1),_r=n("align<br> icon above",1),vr=n("align<br> icon below",1),mr=n("<section><!> <!> <!></section> <section><!> <!> <!></section> <section><!> <!> <!></section> <section><!> <!> <!></section> <section><!> <!> <!></section> <section><!> <!> <!></section> <section><!> <!></section> <section><!> <!></section>",1);function Ar(B,D){rr(D,!1);const N=ar("Card"),Y=`${l}/library`;tr();var _=X(),z=W(_);er(z,{tome:N,children:(H,gr)=>{var v=mr(),m=W(v),u=s(m);i(u,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var g=r(r(u,!0));i(g,{content:`<Card>
  just<br />
  a card
</Card>`});var S=r(r(g,!0));d(S,{children:(a,o)=>{var t=or();e(a,t)}});var f=r(r(m,!0)),b=s(f);c(b,{text:"With a custom icon",slug:"custom-icon"});var p=r(r(b,!0));i(p,{content:`<Card>
  custom<br />
  icon
  {#snippet icon()}📖{/snippet}
</Card>`});var q=r(r(p,!0));d(q,{icon:o=>{var t=nr();e(o,t)},children:(o,t)=>{var V=ir();e(o,V)}});var C=r(r(f,!0)),h=s(C);c(h,{text:"As a link",slug:"as-a-link"});var $=r(r(h,!0));i($,{content:`<Card href="${l}/">
  a<br />
  link
