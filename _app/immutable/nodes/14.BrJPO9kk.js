import{a as e,t as d,k as D}from"../chunks/disclose-version.BmNp8pRT.js";import{f as m,p as F,a as G,s as r,c as b,a4 as o,r as C}from"../chunks/runtime.CTRYSQ17.js";import{b as P}from"../chunks/entry.Diwjvpa9.js";import{C as c}from"../chunks/Code.DpTM-mqG.js";import{g as J}from"../chunks/tome.C9iqdKFN.js";import{C as v}from"../chunks/Card.DsQVEjfu.js";import{T as K}from"../chunks/Tome_Content.zW8Dtgjh.js";import{T as u,a as g}from"../chunks/Tome_Section_Header.B767Pkdw.js";var O=d("just<br> a card",1),Q=d("custom<br> icon",1),U=d("<!> <!> <!>",1),V=d("a<br> link",1),X=d("<!> <!> <!>",1),Z=d("href is<br> selected",1),rr=d("<!> <!> <!>",1),tr=d("custom<br> tag",1),or=d("<!> <!> <!>",1),ar=d("align<br> icon right",1),er=d("<!> <!> <!>",1),nr=d("align<br> icon above",1),sr=d("align<br> icon below",1),dr=d("<section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function pr(j,B){G(B,!0);const H=J("Card"),x=`${P}/library`;K(j,{tome:H,children:(N,ir)=>{var T=dr(),p=m(T),k=b(p);c(k,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var A=r(k,2);c(A,{content:`<Card>
  just<br />
  a card
