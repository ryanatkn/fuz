var Ze=Object.defineProperty;var ze=s=>{throw TypeError(s)};var Je=(s,t,e)=>t in s?Ze(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var mt=(s,t,e)=>Je(s,typeof t!="symbol"?t+"":t,e),fe=(s,t,e)=>t.has(s)||ze("Cannot "+e);var S=(s,t,e)=>(fe(s,t,"read from private field"),e?e.call(s):t.get(s)),G=(s,t,e)=>t.has(s)?ze("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,e),ge=(s,t,e,a)=>(fe(s,t,"write to private field"),a?a.call(s,e):t.set(s,e),e),Ee=(s,t,e)=>(fe(s,t,"access private method"),e);import{a as o,t as A,k as Ce,j as E,c as st,m as We,x as Qe,y as tn}from"../chunks/disclose-version.qccFV9AM.js";import{m as en,u as nn,f as q,s as p,k as C,a4 as D,l as y,a6 as N,g as n,G as h,a as lt,t as K,p as ut,d as V,X as Dt,an as Tt,a3 as me}from"../chunks/runtime.B2HyCRSG.js";import{T as on}from"../chunks/Tome_Content.BTkOJVdP.js";import{g as sn}from"../chunks/tome.BiGXqLEw.js";import{M as ae}from"../chunks/Mdn_Link.B3a2EtLf.js";import{T as It,a as Pt}from"../chunks/Tome_Section_Header.UWFteg0G.js";import{p as W,i as U}from"../chunks/store.CItsiEdH.js";import{c as Te,e as Mt}from"../chunks/context_helpers.DIuDWXkJ.js";import{t as Nt,a as Oe,c as an,s as rn}from"../chunks/index.CwIivG9O.js";import{C as Rt}from"../chunks/Code.CziE7ju_.js";import{s as _t,b as ce,r as cn}from"../chunks/attributes.LBTBdhoE.js";import{a as ct}from"../chunks/intersect.C2iU56M7.js";import{s as re}from"../chunks/style.PwPRnE0L.js";import{b as Ie}from"../chunks/this.ixia0uAj.js";import{p as tt,s as Ue}from"../chunks/props.DO01tcwN.js";import{a as ln,s as zt,b as xe,c as Ne,D as un}from"../chunks/Dialog.wYYSzMF_.js";import{o as De}from"../chunks/index-client.DfRMKLmL.js";import{s as vt}from"../chunks/render.DuAIDw5y.js";import{a as be}from"../chunks/string.ZJuK4sHN.js";import{t as pt}from"../chunks/class.Dw6Ly5wt.js";import{P as dn}from"../chunks/Pending_Animation.DFs68OvO.js";import{D as mn,b as Me}from"../chunks/Details.DJ6qgFQQ.js";import{S as _n,g as vn}from"../chunks/logos.CP8gW8zO.js";import{C as hn,T as pn}from"../chunks/Theme_Input.DqfZkCiQ.js";import{b as Re}from"../chunks/input.CkNYDfOu.js";var bt,Et,qt,ue,Be;const de=class de{constructor(t){G(this,ue);G(this,bt,new WeakMap);G(this,Et);G(this,qt);ge(this,qt,t)}observe(t,e){var a=S(this,bt).get(t)||new Set;return a.add(e),S(this,bt).set(t,a),Ee(this,ue,Be).call(this).observe(t,S(this,qt)),()=>{var i=S(this,bt).get(t);i.delete(e),i.size===0&&(S(this,bt).delete(t),S(this,Et).unobserve(t))}}};bt=new WeakMap,Et=new WeakMap,qt=new WeakMap,ue=new WeakSet,Be=function(){return S(this,Et)??ge(this,Et,new ResizeObserver(t=>{for(var e of t){de.entries.set(e.target,e);for(var a of S(this,bt).get(e.target)||[])a(e)}}))},mt(de,"entries",new WeakMap);let $e=de;var fn=new $e({box:"border-box"});function qe(s,t,e){var a=fn.observe(s,()=>e(s[t]));en(()=>(nn(()=>e(s[t])),a))}var gn=A('<span class="font_mono">contextmenu</span> event',1),xn=A('<span class="font_mono">navigator.vibrate</span>'),bn=A('<span class="font_mono">navigator.vibrate</span>'),yn=A(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
...
Try selecting text and then opening the contextmenu on it.`,I=V(()=>n(l)===r||n(l)===g||n(l)===T);ne(s,{contextmenu:e,scoped:!0,children:(z,w)=>{It(z,{children:(c,v)=>{var m=Io(),b=q(m),f=C(b);Pt(f,{text:"Select text"}),y(b);var u=p(b,2);xt(u,{entries:O=>{nt(O,{run:()=>h(a,!n(a)),children:(F,$)=>{D();var k=E("Toggle something");o(F,k)},$$slots:{default:!0}})},children:(O,F)=>{var $=To(),k=C($),R=p(C(k),2),X=p(C(R));X.__click=[Co,i],D(),y(R),y(k),Ie(k,P=>h(i,P),()=>n(i));var at=p(k,2),J=C(at);cn(J),y(at);var B=p(at,2),et=p(B,2),Q=C(et);tn(Q),y(et);var Y=p(et,2),j=C(Y);ae(j,{path:"Web/HTML/Global_attributes/contenteditable"}),D(),y(Y);var rt=p(Y,4),yt=p(rt,4);y($),K(()=>{pt($,"color_g_5",n(I)),pt(X,"color_a",n(a)),pt(B,"color_g_5",n(I))}),Re(J,()=>n(l),P=>h(l,P)),Re(Q,()=>n(l),P=>h(l,P)),Me("innerText",rt,()=>n(l),P=>h(l,P)),Me("innerText",yt,()=>n(l),P=>h(l,P)),o(O,$)},$$slots:{entries:!0,default:!0}}),K(()=>pt(b,"color_d_5",n(I))),o(c,m)},$$slots:{default:!0}})},$$slots:{default:!0}}),ut()}Ce(["click"]);var So=A(`<!> <div class="panel p_md"><!> <p>Opening the contextmenu on <a href="https://www.fuz.dev/">a link like this one</a> has
