...
`;var Ro=$("<!> <!>",1),Do=$('<div class="cat_wrapper svelte-ki3ktl"><!></div>'),Fo=$('<div class="position home svelte-ki3ktl"><div class="icon svelte-ki3ktl">🏠</div> <div class="cats svelte-ki3ktl"></div></div>'),Mo=$('<div class="cat_wrapper svelte-ki3ktl"><!></div>'),Lo=$('<div class="position adventure svelte-ki3ktl"><div class="icon svelte-ki3ktl">🌄</div> <div class="cats svelte-ki3ktl"></div></div>'),Ho=$('<section class="display_flex"><div><!> <!></div></section> <section><!></section>',1),Uo=$("<!> <!>",1),qo=$('<div class="mx_auto box"><div class="pane p_xl text_align_center"><h1>About Fuz</h1> <blockquote>Svelte UI library</blockquote> <blockquote>free and open source at<br/><a href="https://github.com/ryanatkn/fuz">github.com/ryanatkn/fuz</a></blockquote> <code class="display_block p_md mb_lg">npm i -D <a href="https://www.npmjs.com/package/@fuz.dev/fuz_contextmenu">@fuz.dev/fuz_contextmenu</a></code> <div class="p_xl box"><h2>Color scheme</h2> <!> <h2>Theme</h2> <!></div></div></div>'),Bo=$("<!> <!>",1);function Wo(s,t){yt(t,!0);const n=Mt.get(),c=P(()=>n.component),_="Alyssa",i="Ben",u="home";let l=D(u),v=D(u);const f=P(()=>e(l)===e(v)?"😺":"😾"),M=P(()=>e(l)===e(v)?"😸":"😿"),A=P(()=>({name:_,icon:e(f),position:e(l)})),p=P(()=>({name:i,icon:e(M),position:e(v)}));let g=D(!1);const x=(N,G)=>{const et=[],V=[];for(const U of N){const st=U.position==="home"?et:V;G?st.unshift(U):st.push(U)}return{home_cats:et,adventure_cats:V}},w=P(()=>x([e(A),e(p)],e(g))),k=P(()=>e(w).home_cats),h=P(()=>e(w).adventure_cats),C=P(()=>e(l)!==u||e(v)!==u),X=()=>{a(l,u),a(v,u)};let Q=D(!1);const I=()=>{a(Q,!e(Q))},O=N=>{switch(N.type){case"call_cats_adventure":{a(l,"adventure"),a(v,"adventure");break}case"call_cats_home":{a(l,"home"),a(v,"home");break}case"cat_go_adventure":{N.name===_?a(l,"adventure"):N.name===i&&a(v,"adventure");break}case"cat_go_home":{N.name===_?a(l,"home"):N.name===i&&a(v,"home");break}case"cat_be_or_do":{a(g,!e(g));break}}},[E,R]=gn({fallback:(N,G)=>{const et=window.getComputedStyle(N),V=et.transform==="none"?"":et.transform;return{duration:1500,easing:ho,css:U=>`
					transform: ${V} scale(${U});
					opacity: ${U}
				`}}});var b=Bo(),q=S(b);Bt(q,()=>e(c),(N,G)=>{G(N,{scoped:!0,children:(et,V)=>{Dt(et,{children:(U,st)=>{var ct=Uo(),it=S(ct);Ft(it,{text:"Full example"});var xt=r(it,2);At(xt,{entries:bt=>{var L=Ro(),j=S(L);{var J=Y=>{Ee(Y,{run:X,content:"Reset",icon:"↻"})};Z(j,Y=>{e(C)&&Y(J)})}var W=r(j,2);wo(W,{toggle_about_dialog:I}),o(bt,L)},children:(bt,L)=>{var j=Ho(),J=S(j),W=m(J),Y=m(W);At(Y,{entries:at=>{To(at,{act:O,get home_cats(){return e(k)},get adventure_cats(){return e(h)}})},children:(at,kt)=>{var vt=Fo(),It=r(m(vt),2);Vt(It,29,()=>e(k),({name:T,icon:H,position:K})=>T,(T,H)=>{let K=()=>e(H).name,rt=()=>e(H).icon,nt=()=>e(H).position;var mt=Do(),Pt=m(mt);At(Pt,{entries:St=>{ve(St,{act:O,get name(){return K()},get icon(){return rt()},get position(){return nt()}})},children:(St,Ot)=>{Me(St,{get name(){return K()},get icon(){return rt()}})},$$slots:{entries:!0,default:!0}}),d(mt),ee(1,mt,()=>R,()=>({key:K()})),ee(2,mt,()=>E,()=>({key:K()})),Re(mt,()=>Fe,null),o(T,mt)}),d(It),d(vt),o(at,vt)},$$slots:{entries:!0,default:!0}});var pt=r(Y,2);At(pt,{entries:at=>{Io(at,{act:O,get home_cats(){return e(k)},get adventure_cats(){return e(h)}})},children:(at,kt)=>{var vt=Lo(),It=r(m(vt),2);Vt(It,29,()=>e(h),({name:T,icon:H,position:K})=>T,(T,H)=>{let K=()=>e(H).name,rt=()=>e(H).icon,nt=()=>e(H).position;var mt=Mo(),Pt=m(mt);At(Pt,{entries:St=>{ve(St,{act:O,get name(){return K()},get icon(){return rt()},get position(){return nt()}})},children:(St,Ot)=>{Me(St,{get name(){return K()},get icon(){return rt()}})},$$slots:{entries:!0,default:!0}}),d(mt),ee(1,mt,()=>R,()=>({key:K()})),ee(2,mt,()=>E,()=>({key:K()})),Re(mt,()=>Fe,null),o(T,mt)}),d(It),d(vt),o(at,vt)},$$slots:{entries:!0,default:!0}}),d(W),d(J);var ut=r(J,2),Lt=m(ut);Ue(Lt,{summary:at=>{F();var kt=B("View example source");o(at,kt)},children:(at,kt)=>{qt(at,{get content(){return No}})},$$slots:{summary:!0,default:!0}}),d(ut),o(bt,j)},$$slots:{entries:!0,default:!0}}),o(U,ct)},$$slots:{default:!0}})},$$slots:{default:!0}})});var y=r(q,2);{var z=N=>{hn(N,{onclose:()=>a(Q,!1),children:(G,et)=>{var V=qo(),U=m(V),st=r(m(U),8),ct=r(m(st),2);wn(ct,{});var it=r(ct,4);$n(it,{}),d(st),d(U),d(V),o(G,V)},$$slots:{default:!0}})};Z(y,N=>{e(Q)&&N(z)})}o(s,b),wt()}var Xo=$("<!> <!> <!>",1),Yo=$(`<div class="panel p_md"><p>Try opening the contextmenu on this panel with rightclick or tap-and-hold.</p> <!> <div><code> </code></div> <div><code> </code></div> <div><code> </code></div> <aside class="mt_lg">The <code>scoped</code> prop is only needed when mounting a contextmenu inside a specific element
					instead of the entire page.</aside></div>`),jo=$("<!> <!>",1);function Vo(s,t){yt(t,!0);const n=Mt.get(),c=P(()=>n.component),_=P(()=>n.name);let i=D(!1),u=D(!1),l=D(!1);var v=tt(),f=S(v);Bt(f,()=>e(c),(M,A)=>{A(M,{scoped:!0,children:(p,g)=>{Dt(p,{children:(x,w)=>{var k=jo(),h=S(k);Ft(h,{text:"Basic usage"});var C=r(h,2);At(C,{entries:Q=>{var I=Xo(),O=S(I);_t(O,{run:()=>void a(i,!e(i)),children:(b,q)=>{F();var y=B("Hello world");o(b,y)},$$slots:{default:!0}});var E=r(O,2);_t(E,{run:()=>void a(u,!e(u)),icon:q=>{F();var y=B("🌞");o(q,y)},children:(q,y)=>{F();var z=B("Hello with an optional icon snippet");o(q,z)},$$slots:{icon:!0,default:!0}});var R=r(E,2);_t(R,{run:()=>void a(l,!e(l)),icon:"🌚",children:(b,q)=>{F();var y=B("Hello with an optional icon string");o(b,y)},$$slots:{default:!0}}),o(Q,I)},children:(Q,I)=>{var O=Yo(),E=r(m(O),2);{let it=P(()=>`<${e(_)} scoped>
  <Contextmenu>
    {#snippet entries()}
...
...markup without contextmenu behavior...`);qt(E,{get content(){return e(it)}})}var R=r(E,2),b=m(R);let q;var y=m(b);d(b),d(R);var z=r(R,2),N=m(z);let G;var et=m(N);d(N),d(z);var V=r(z,2),U=m(V);let st;var ct=m(U);d(U),d(V),F(2),d(O),lt((it,xt,$t)=>{q=ft(b,1,"",null,q,it),gt(y,`greeted = ${e(i)??""}`),G=ft(N,1,"",null,G,xt),gt(et,`greeted_icon_snippet = ${e(u)??""}`),st=ft(U,1,"",null,st,$t),gt(ct,`greeted_icon_string = ${e(l)??""}`)},[()=>({color_g_5:e(i)}),()=>({color_e_5:e(u)}),()=>({color_d_5:e(l)})]),o(Q,O)},$$slots:{entries:!0,default:!0}}),o(x,k)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(s,v),wt()}var Ko=$("<span> </span>");function te(s,t){const n=Le(t,["$$slots","$$events","$$legacy","glyph","size","class"]),c="var(--font_size, 1em)",_="var(--font_size, inherit)",i=P(()=>t.size??c);var u=Ko();ke(u,v=>({...n,class:`glyph display_inline_block text_align_center line_height_1 white_space_nowrap font_weight_400 ${t.class??""}`,[vn]:v}),[()=>({width:e(i),height:e(i),"min-width":e(i),"min-height":e(i),"font-size":t.size??_})]);var l=m(u,!0);d(u),lt(()=>gt(l,t.glyph)),o(s,u)}var Go=$('<span class="color_f_5">option f</span>'),Zo=$('<span class="color_g_5">option g</span>'),Jo=$('<span class="color_j_5">option j</span>'),Qo=$("<!> <!> <!> <!>",1),ts=$('<li class="color_error">Error: <code> </code></li>'),es=$('<div class="display_flex"><div class="box"><button type="button"><!></button> <div class="row"><button type="button"><!></button> <button type="button"><!></button> <button type="button"><!></button></div> <button type="button"><!></button></div></div>'),ns=$(`<div class="panel p_md"><p class="mb_md">The <code> </code> prop <code>contextmenu</code> accepts a custom <code>Contextmenu_State</code> instance, allowing you to observe its reactive state and control
					...
					activate button (↵).</p> <div><p>Reactive state:</p> <ul><li><code>contextmenu.opened</code> === <code> </code></li> <li><code>contextmenu.x</code> === <code> </code></li> <!></ul></div> <!></div>`),os=$("<!> <!>",1);function ss(s,t){yt(t,!0);const n=Mt.get(),c=P(()=>n.component),_=P(()=>n.name),i=new oe;let u=D(void 0);const l=P(()=>e(u)?`color_${e(u)}_5`:void 0),v=P(()=>e(u)?`color_${e(u)}`:void 0);var f=tt(),M=S(f);Bt(M,()=>e(c),(A,p)=>{p(A,{get contextmenu(){return i},scoped:!0,children:(g,x)=>{Dt(g,{children:(w,k)=>{var h=os(),C=S(h);Ft(C,{text:"Custom instance"});var X=r(C,2);At(X,{entries:I=>{pe(I,{icon:R=>{F();var b=B("🎨");o(R,b)},menu:R=>{var b=Qo(),q=S(b);_t(q,{run:()=>(a(u,"f"),{ok:!0,close:!1}),children:(G,et)=>{var V=Go();o(G,V)},$$slots:{default:!0}});var y=r(q,2);_t(y,{run:()=>(a(u,"g"),{ok:!0,close:!1}),children:(G,et)=>{var V=Zo();o(G,V)},$$slots:{default:!0}});var z=r(y,2);_t(z,{run:()=>(a(u,"j"),{ok:!0,close:!1}),children:(G,et)=>{var V=Jo();o(G,V)},$$slots:{default:!0}});var N=r(z,2);_t(N,{run:()=>(i.close(),{ok:!0}),children:(G,et)=>{F();var V=B("close contextmenu");o(G,V)},$$slots:{default:!0}}),o(R,b)},children:(R,b)=>{F();var q=B("select color");o(R,q)},$$slots:{icon:!0,menu:!0,default:!0}})},children:(I,O)=>{var E=ns(),R=m(E),b=r(m(R)),q=m(b,!0);d(b),F(5),d(R);var y=r(R,2);qt(y,{lang:"ts",content:"const contextmenu = new Contextmenu_State();"});var z=r(y,2);{let W=P(()=>`<${e(_)} {contextmenu} scoped>...</${e(_)}>`);qt(z,{get content(){return e(W)}})}var N=r(z,2),G=r(m(N));G.textContent="{ok: true, close: false}",F(),d(N);var et=r(N,2),V=r(m(et),2),U=m(V),st=r(m(U),2),ct=m(st,!0);d(st),d(U);var it=r(U,2),xt=r(m(it),2),$t=m(xt);d(xt),d(it);var bt=r(it,2);{var L=W=>{var Y=ts(),pt=r(m(Y)),ut=m(pt,!0);d(pt),d(Y),lt(()=>gt(ut,i.error)),o(W,Y)};Z(bt,W=>{i.error&&W(L)})}d(V),d(et);var j=r(et,2);{var J=W=>{var Y=es(),pt=m(Y),ut=m(pt),Lt=m(ut);te(Lt,{glyph:"↑"}),d(ut);var Et=r(ut,2),at=m(Et),kt=m(at);te(kt,{glyph:"←"}),d(at);var vt=r(at,2),It=m(vt);te(It,{glyph:"↵"}),d(vt);var T=r(vt,2),H=m(T);te(H,{glyph:"→"}),d(T),d(Et);var K=r(Et,2),rt=m(K);te(rt,{glyph:"↓"}),d(K),d(pt),d(Y),lt(()=>{ft(ut,1,`border_bottom_left_radius_0 border_bottom_right_radius_0 ${e(v)??""}`),ut.disabled=!i.can_select_previous,ft(at,1,`border_bottom_right_radius_0 border_top_right_radius_0 ${e(v)??""}`),at.disabled=!i.can_collapse,ft(vt,1,`border_radius_0 ${e(v)??""}`),vt.disabled=!i.can_activate,ft(T,1,`border_bottom_left_radius_0 border_top_left_radius_0 ${e(v)??""}`),T.disabled=!i.can_expand,ft(K,1,`border_top_left_radius_0 border_top_right_radius_0 ${e(v)??""}`),K.disabled=!i.can_select_next}),ht("mousedown",ut,nt=>{Ct(nt),i.select_previous()},!0),ht("mousedown",at,nt=>{Ct(nt),i.collapse_selected()},!0),ht("mousedown",vt,async nt=>{Ct(nt),await i.activate_selected()},!0),ht("mousedown",T,nt=>{Ct(nt),i.expand_selected()},!0),ht("mousedown",K,nt=>{Ct(nt),i.select_next()},!0),ee(3,Y,()=>xn),o(W,Y)};Z(j,W=>{i.opened&&W(J)})}d(E),lt(()=>{gt(q,e(_)),ft(et,1,`mb_md ${e(l)??""}`),gt(ct,i.opened),gt($t,`${i.x??""} && contextmenu.y === ${i.y??""}`)}),o(I,E)},$$slots:{entries:!0,default:!0}}),o(w,h)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(s,f),wt()}const as=(s,t)=>{const n=window.getSelection();if(!n||!e(t))return;const c=document.createRange();c.selectNodeContents(e(t)),n.removeAllRanges(),n.addRange(c)};var rs=$(`<div><div class="mb_lg"><p>When the Fuz contextmenu opens and the user has selected text, the menu includes a <code>copy text</code> entry.</p> <p>Try <button type="button">selecting text</button> and then opening the contextmenu on it.</p></div> <label class="svelte-1efz8xy"><input type="text" placeholder="paste text here?"/></label> <p>Opening the contextmenu on an <code>input</code> or <code>textarea</code> opens the browser's
