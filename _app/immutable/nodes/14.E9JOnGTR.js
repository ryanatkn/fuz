import{a as e,t as l,j as D}from"../chunks/disclose-version.qccFV9AM.js";import{f as m,p as F,a as G,s as r,k as b,a4 as o,l as C}from"../chunks/runtime.B2HyCRSG.js";import{b as P}from"../chunks/entry.C0p58QK4.js";import{C as c}from"../chunks/Code.CziE7ju_.js";import{g as J}from"../chunks/tome.BRswXeJT.js";import{C as v}from"../chunks/Card.Bixxh8B0.js";import{T as K}from"../chunks/Tome_Content.BBL2WRov.js";import{T as u,a as g}from"../chunks/Tome_Section_Header.D5ZSelpn.js";var O=l("just<br> a card",1),Q=l("custom<br> icon",1),U=l("<!> <!> <!>",1),V=l("a<br> link",1),X=l("<!> <!> <!>",1),Z=l("href is<br> selected",1),rr=l("<!> <!> <!>",1),tr=l("custom<br> tag",1),or=l("<!> <!> <!>",1),ar=l("align<br> icon right",1),er=l("<!> <!> <!>",1),nr=l("align<br> icon above",1),sr=l("align<br> icon below",1),lr=l("<section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function pr(W,B){G(B,!0);const H=J("Card"),x=`${P}/library`;K(W,{tome:H,children:(N,ir)=>{var T=lr(),p=m(T),k=b(p);c(k,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var A=r(k,2);c(A,{content:`<Card>
  just<br />
  a card
