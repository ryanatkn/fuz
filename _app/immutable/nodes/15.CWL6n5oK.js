var Qe=Object.defineProperty;var Ze=(i,t,e)=>t in i?Qe(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var it=(i,t,e)=>(Ze(i,typeof t!="symbol"?t+"":t,e),e),he=(i,t,e)=>{if(!t.has(i))throw TypeError("Cannot "+e)};var P=(i,t,e)=>(he(i,t,"read from private field"),e?e.call(i):t.get(i)),B=(i,t,e)=>{if(t.has(i))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(i):t.set(i,e)},pe=(i,t,e,s)=>(he(i,t,"write to private field"),s?s.call(i,e):t.set(i,e),e);var Ee=(i,t,e)=>(he(i,t,"access private method"),e);import{a as r,t as d,c as $,s as n,f as h,b as E,m as At,$ as Pt}from"../chunks/disclose-version.BiO56WOZ.js";import{i as He,u as tn,r as en,aw as nn,I as O,g as o,w as x,s as be,f as ye,p as mt,t as G,a as ht,d as R,a3 as Ht,a5 as F,K as Pe}from"../chunks/runtime.4XppMexo.js";import{T as on}from"../chunks/Tome_Detail.pCy9FOWh.js";import{g as rn}from"../chunks/tome.BlqKGtcw.js";import{M as ce}from"../chunks/Mdn_Link.sgc1PI8Z.js";import{T as St}from"../chunks/Tome_Subheading.BbxNcUp0.js";import{i as L}from"../chunks/if.DC6teSPQ.js";import{e as Ut}from"../chunks/each.BULo1qSU.js";import{t as Lt,a as Ae,c as an,s as sn}from"../chunks/index.BEL3NXfl.js";import{C as Wt}from"../chunks/Code.B2fK3yjq.js";import{d as we,s as ct,e as et}from"../chunks/render.BE-6yyhv.js";import{p as M}from"../chunks/proxy.DDl-qTAZ.js";import{s as lt,b as de,r as cn,e as ln}from"../chunks/attributes.BvC5j5MS.js";import{s as le}from"../chunks/style.iv2mhl8q.js";import{b as $e}from"../chunks/this.CstQ5u6B.js";import{p as J,s as Se}from"../chunks/props.Y8LKXRlj.js";import{a as un,s as Mt,b as fe,c as ze,D as dn}from"../chunks/Dialog.CIIvHipI.js";import{o as Oe}from"../chunks/index-client.DMbNsG50.js";import{a as ge}from"../chunks/string.ZJuK4sHN.js";import{t as bt}from"../chunks/class.D8qLjRNt.js";import{P as _n}from"../chunks/Pending_Animation.DQO5p2Dg.js";import{D as vn,b as Ne}from"../chunks/Details.CI8-97-e.js";import{G as mn}from"../chunks/Github_Logo.GfrQ7pAl.js";import{C as hn,T as pn}from"../chunks/Theme_Input.BtndsR_L.js";import{b as Fe}from"../chunks/input.B-nXmA4O.js";function fn(i,t,e){He(()=>{var s=tn(()=>t(i,e==null?void 0:e())||{});if(e&&(s!=null&&s.update)){var a=!1;en(()=>{var c=e();nn(c),a&&s.update(c)}),a=!0}if(s!=null&&s.destroy)return()=>s.destroy()})}var kt,Dt,Bt,ve,Ue;const me=class me{constructor(t){B(this,ve);B(this,kt,new WeakMap);B(this,Dt,void 0);B(this,Bt,void 0);pe(this,Bt,t)}observe(t,e){var s=P(this,kt).get(t)||new Set;return s.add(e),P(this,kt).set(t,s),Ee(this,ve,Ue).call(this).observe(t,P(this,Bt)),()=>{var a=P(this,kt).get(t);a.delete(e),a.size===0&&(P(this,kt).delete(t),P(this,Dt).unobserve(t))}}};kt=new WeakMap,Dt=new WeakMap,Bt=new WeakMap,ve=new WeakSet,Ue=function(){return P(this,Dt)??pe(this,Dt,new ResizeObserver(t=>{for(var e of t){me.entries.set(e.target,e);for(var s of P(this,kt).get(e.target)||[])s(e)}}))},it(me,"entries",new WeakMap);let xe=me;var gn=new xe({box:"border-box"});function Me(i,t,e){var s=gn.observe(i,()=>e(i[t]));He(()=>(e(i[t]),s))}var xn=d('<span class="font_mono">contextmenu</span> event',1),bn=d('<span class="font_mono">navigator.vibrate</span>'),yn=d('<span class="font_mono">navigator.vibrate</span>'),wn=d(`<section><!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
