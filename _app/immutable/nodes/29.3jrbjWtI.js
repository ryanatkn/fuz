...
];`});var _=e(w,2),x=s(_),m=s(x),h=e(s(m),2),b=e(s(h));y(b,{name:"required_trust_defaults_base"}),t(h),t(m),t(x);var S=e(x);ce(S,20,()=>[null].concat(Ee),A=>A,(A,f)=>{var z=Ne(),$=s(z),G=s($);{let l=qe(()=>H(f));q(G,{get content(){return M(l)}})}t($);var E=e($);{var U=l=>{var C=je();r(l,C)},_e=l=>{var C=Y(),be=v(C);{var ye=P=>{var I=Fe();r(P,I)},ge=P=>{var I=Y(),ke=v(I);{var we=T=>{var j=Me();r(T,j)},xe=T=>{var j=Y(),Se=v(j);{var $e=W=>{var Ce=Le();r(W,Ce)};N(Se,W=>{f==="high"&&W($e)},!0)}r(T,j)};N(ke,T=>{f==="medium"?T(we):T(xe,!1)},!0)}r(P,I)};N(be,P=>{f==="low"?P(ye):P(ge,!1)},!0)}r(l,C)};N(E,l=>{f===null?l(U):l(_e,!1)})}var ae=e(E),oe=s(ae),he=s(oe,!0);t(oe),t(ae),t(z),ie(l=>L(he,l),[()=>Object.entries(Ie).filter(([l,C])=>C===f).map(([l])=>H(l)).join(", ")]),r(A,z)}),t(S),t(_),n(2),r(c,a)},$$slots:{default:!0}});var Z=e(X,2);D(Z,{children:(c,k)=>{var a=Oe(),d=v(a);O(d,{text:"Explicit directives"});var i=e(d,4);q(i,{content:`export const my_csp_trusted_sources: Array<CspSourceSpec> = [
...
});`,lang:"ts"}),r(c,a)},$$slots:{default:!0}});var te=e(ee,2);D(te,{children:(c,k)=>{var a=Ge(),d=v(a);O(d,{text:"Directive specs"});var i=e(d,2),p=e(s(i));y(p,{name:"csp_directive_specs"});var w=e(p,2);ne(w,{path:"Web/HTTP/Reference/Headers/Content-Security-Policy",children:(m,h)=>{n();var b=F("CSP directives");r(m,b)},$$slots:{default:!0}}),n(),t(i);var _=e(i,2),x=e(s(_));ce(x,21,()=>de,m=>m.name,(m,h)=>{var b=Be(),S=s(b),A=s(S,!0);t(S);var f=e(S),z=s(f,!0);t(f);var $=e(f),G=s($,!0);t($),t(b),ie((E,U)=>{L(A,M(h).name),L(z,E),L(G,U)},[()=>M(h).fallback?.join(", ")||"",()=>M(h).fallback_of?.join(", ")||""]),r(m,b)}),t(x),t(_),r(c,a)},$$slots:{default:!0}});var se=e(te,2),re=e(s(se));le(re,{path:"ryanatkn/fuz/blob/main/src/lib/csp.ts",children:(c,k)=>{n();var a=F("source code");r(c,a)},$$slots:{default:!0}});var ve=e(re,2);le(ve,{path:"ryanatkn/fuz/blob/main/src/lib/csp.test.ts",children:(c,k)=>{n();var a=F("tests");r(c,a)},$$slots:{default:!0}}),n(),t(se),r(fe,J)},$$slots:{default:!0}}),Te()}export{at as component};
