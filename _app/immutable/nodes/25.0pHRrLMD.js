import{n as rn,e as h,c as f,a as I,d as v,i as z,N as cn,p as W,s as N,f as R,v as Y,w as L,x as B,A as Z,t as j,b as q,l as H,m as F,g as x,j as U}from"../chunks/scheduler.CgQa5F6Q.js";import{S as _n,i as on,g as en,b as d,e as ln,t as i,c as O,a as S,m as C,d as T}from"../chunks/index.qh0IGHud.js";import{C as K}from"../chunks/Code.C5dc7Aj5.js";import{T as sn}from"../chunks/Tome_Detail.Cg29tGCL.js";import{g as pn}from"../chunks/tome.CFgzVi84.js";const gn=`/* @ryanatkn/fuz/utility_classes.css */
...
`,dn=`/* @ryanatkn/fuz/variable_classes.css */
...
`,xn=`/* @ryanatkn/fuz/semantic_classes.css */
...
`,vn=e=>({}),nn=e=>({}),mn=e=>({}),an=e=>({});function bn(e){let n,t;const a=e[3].summary,r=W(a,e,e[2],nn),c=e[3].default,o=W(c,e,e[2],null);return{c(){r&&r.c(),n=N(),o&&o.c()},l(_){r&&r.l(_),n=R(_),o&&o.l(_)},m(_,l){r&&r.m(_,l),z(_,n,l),o&&o.m(_,l),t=!0},p(_,l){r&&r.p&&(!t||l&4)&&Y(r,a,_,_[2],t?B(a,_[2],l,vn):L(_[2]),nn),o&&o.p&&(!t||l&4)&&Y(o,c,_,_[2],t?B(c,_[2],l,null):L(_[2]),null)},i(_){t||(i(r,_),i(o,_),t=!0)},o(_){d(r,_),d(o,_),t=!1},d(_){_&&v(n),r&&r.d(_),o&&o.d(_)}}}function hn(e){let n,t,a;const r=e[3].summary,c=W(r,e,e[2],an);let o=e[0]&&tn(e);return{c(){c&&c.c(),n=N(),o&&o.c(),t=Z()},l(_){c&&c.l(_),n=R(_),o&&o.l(_),t=Z()},m(_,l){c&&c.m(_,l),z(_,n,l),o&&o.m(_,l),z(_,t,l),a=!0},p(_,l){c&&c.p&&(!a||l&4)&&Y(c,r,_,_[2],a?B(r,_[2],l,mn):L(_[2]),an),_[0]?o?(o.p(_,l),l&1&&i(o,1)):(o=tn(_),o.c(),i(o,1),o.m(t.parentNode,t)):o&&(en(),d(o,1,1,()=>{o=null}),ln())},i(_){a||(i(c,_),i(o),a=!0)},o(_){d(c,_),d(o),a=!1},d(_){_&&(v(n),v(t)),c&&c.d(_),o&&o.d(_)}}}function tn(e){let n;const t=e[3].default,a=W(t,e,e[2],null);return{c(){a&&a.c()},l(r){a&&a.l(r)},m(r,c){a&&a.m(r,c),n=!0},p(r,c){a&&a.p&&(!n||c&4)&&Y(a,t,r,r[2],n?B(t,r[2],c,null):L(r[2]),null)},i(r){n||(i(a,r),n=!0)},o(r){d(a,r),n=!1},d(r){a&&a.d(r)}}}function fn(e){let n,t,a,r,c,o;const _=[hn,bn],l=[];function D(s,m){return s[1]?0:1}return t=D(e),a=l[t]=_[t](e),{c(){n=h("details"),a.c()},l(s){n=f(s,"DETAILS",{});var m=I(n);a.l(m),m.forEach(v)},m(s,m){z(s,n,m),l[t].m(n,null),n.open=e[0],r=!0,c||(o=cn(n,"toggle",e[4]),c=!0)},p(s,[m]){let g=t;t=D(s),t===g?l[t].p(s,m):(en(),d(l[g],1,1,()=>{l[g]=null}),ln(),a=l[t],a?a.p(s,m):(a=l[t]=_[t](s),a.c()),i(a,1),a.m(n,null)),m&1&&(n.open=s[0])},i(s){r||(i(a),r=!0)},o(s){d(a),r=!1},d(s){s&&v(n),l[t].d(),c=!1,o()}}}function un(e,n,t){let{$$slots:a={},$$scope:r}=n,{lazy:c=!0}=n,{open:o=void 0}=n;function _(){o=this.open,t(0,o)}return e.$$set=l=>{"lazy"in l&&t(1,c=l.lazy),"open"in l&&t(0,o=l.open),"$$scope"in l&&t(2,r=l.$$scope)},[o,c,r,a,_]}class J extends _n{constructor(n){super(),on(this,n,un,fn,rn,{lazy:1,open:0})}}function wn(e){let n,t;return n=new K({props:{content:gn,lang:"css"}}),{c(){O(n.$$.fragment)},l(a){S(n.$$.fragment,a)},m(a,r){C(n,a,r),t=!0},p:U,i(a){t||(i(n.$$.fragment,a),t=!0)},o(a){d(n.$$.fragment,a),t=!1},d(a){T(n,a)}}}function kn(e){let n,t="utility classes";return{c(){n=h("summary"),n.textContent=t,this.h()},l(a){n=f(a,"SUMMARY",{slot:!0,"data-svelte-h":!0}),H(n)!=="svelte-1uomx3n"&&(n.textContent=t),this.h()},h(){F(n,"slot","summary")},m(a,r){z(a,n,r)},p:U,d(a){a&&v(n)}}}function yn(e){let n,t;return n=new K({props:{content:dn,lang:"css"}}),{c(){O(n.$$.fragment)},l(a){S(n.$$.fragment,a)},m(a,r){C(n,a,r),t=!0},p:U,i(a){t||(i(n.$$.fragment,a),t=!0)},o(a){d(n.$$.fragment,a),t=!1},d(a){T(n,a)}}}function zn(e){let n,t="variable classes";return{c(){n=h("summary"),n.textContent=t,this.h()},l(a){n=f(a,"SUMMARY",{slot:!0,"data-svelte-h":!0}),H(n)!=="svelte-q6ni2v"&&(n.textContent=t),this.h()},h(){F(n,"slot","summary")},m(a,r){z(a,n,r)},p:U,d(a){a&&v(n)}}}function $n(e){let n,t;return n=new K({props:{content:xn,lang:"css"}}),{c(){O(n.$$.fragment)},l(a){S(n.$$.fragment,a)},m(a,r){C(n,a,r),t=!0},p:U,i(a){t||(i(n.$$.fragment,a),t=!0)},o(a){d(n.$$.fragment,a),t=!1},d(a){T(n,a)}}}function On(e){let n,t="semantic classes";return{c(){n=h("summary"),n.textContent=t,this.h()},l(a){n=f(a,"SUMMARY",{slot:!0,"data-svelte-h":!0}),H(n)!=="svelte-cf6q7v"&&(n.textContent=t),this.h()},h(){F(n,"slot","summary")},m(a,r){z(a,n,r)},p:U,d(a){a&&v(n)}}}function Sn(e){let n,t,a,r,c,o,_="<",l,D,s,m,g,A,Q="Raw CSS",P,u,X,w,G,k,V;return u=new J({props:{$$slots:{summary:[kn],default:[wn]},$$scope:{ctx:e}}}),w=new J({props:{$$slots:{summary:[zn],default:[yn]},$$scope:{ctx:e}}}),k=new J({props:{$$slots:{summary:[On],default:[$n]},$$scope:{ctx:e}}}),{c(){n=h("div"),t=h("section"),a=j("Fuz provides an arbitrary subset of utility classes for CSS, and defers to CSS in "),r=h("a"),c=j("Svelte's "),o=h("code"),l=j(_),D=j("style>"),s=j(` for complex and uncommon patterns. This may change depending on build tool sophistication, like
			a compiler or Vite plugin to remove unused styles.`),m=N(),g=h("section"),A=h("h3"),A.textContent=Q,P=N(),O(u.$$.fragment),X=N(),O(w.$$.fragment),G=N(),O(k.$$.fragment),this.h()},l(p){n=f(p,"DIV",{class:!0});var b=I(n);t=f(b,"SECTION",{});var $=I(t);a=q($,"Fuz provides an arbitrary subset of utility classes for CSS, and defers to CSS in "),r=f($,"A",{href:!0});var E=I(r);c=q(E,"Svelte's "),o=f(E,"CODE",{});var M=I(o);l=q(M,_),D=q(M,"style>"),M.forEach(v),E.forEach(v),s=q($,` for complex and uncommon patterns. This may change depending on build tool sophistication, like
			a compiler or Vite plugin to remove unused styles.`),$.forEach(v),m=R(b),g=f(b,"SECTION",{});var y=I(g);A=f(y,"H3",{"data-svelte-h":!0}),H(A)!=="svelte-8blf9p"&&(A.textContent=Q),P=R(y),S(u.$$.fragment,y),X=R(y),S(w.$$.fragment,y),G=R(y),S(k.$$.fragment,y),y.forEach(v),b.forEach(v),this.h()},h(){F(r,"href","https://svelte.dev/docs/svelte-components#style"),F(n,"class","prose")},m(p,b){z(p,n,b),x(n,t),x(t,a),x(t,r),x(r,c),x(r,o),x(o,l),x(o,D),x(t,s),x(n,m),x(n,g),x(g,A),x(g,P),C(u,g,null),x(g,X),C(w,g,null),x(g,G),C(k,g,null),V=!0},p(p,b){const $={};b&2&&($.$$scope={dirty:b,ctx:p}),u.$set($);const E={};b&2&&(E.$$scope={dirty:b,ctx:p}),w.$set(E);const M={};b&2&&(M.$$scope={dirty:b,ctx:p}),k.$set(M)},i(p){V||(i(u.$$.fragment,p),i(w.$$.fragment,p),i(k.$$.fragment,p),V=!0)},o(p){d(u.$$.fragment,p),d(w.$$.fragment,p),d(k.$$.fragment,p),V=!1},d(p){p&&v(n),T(u),T(w),T(k)}}}function Cn(e){let n,t;return n=new sn({props:{tome:e[0],$$slots:{default:[Sn]},$$scope:{ctx:e}}}),{c(){O(n.$$.fragment)},l(a){S(n.$$.fragment,a)},m(a,r){C(n,a,r),t=!0},p(a,[r]){const c={};r&2&&(c.$$scope={dirty:r,ctx:a}),n.$set(c)},i(a){t||(i(n.$$.fragment,a),t=!0)},o(a){d(n.$$.fragment,a),t=!1},d(a){T(n,a)}}}const Tn="classes";function Dn(e){return[pn(Tn)]}class Rn extends _n{constructor(n){super(),on(this,n,Dn,Cn,rn,{})}}export{Rn as component};
