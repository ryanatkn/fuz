var Ze=Object.defineProperty;var ze=o=>{throw TypeError(o)};var Je=(o,t,e)=>t in o?Ze(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var ut=(o,t,e)=>Je(o,typeof t!="symbol"?t+"":t,e),fe=(o,t,e)=>t.has(o)||ze("Cannot "+e);var z=(o,t,e)=>(fe(o,t,"read from private field"),e?e.call(o):t.get(o)),G=(o,t,e)=>t.has(o)?ze("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(o):t.set(o,e),ge=(o,t,e,a)=>(fe(o,t,"write to private field"),a?a.call(o,e):t.set(o,e),e),Ee=(o,t,e)=>(fe(o,t,"access private method"),e);import{t as E,a as s,k as Ce,j as O,c as at,m as We,y as Qe,z as tn}from"../chunks/CbbyqTNh.js";import{m as en,u as nn,f as q,s as p,k as T,a0 as R,l as w,a2 as D,g as n,G as h,p as vt,t as Z,d as X,a as ht,R as Dt,as as Tt,$ as me}from"../chunks/C9aPwLmV.js";import{T as on}from"../chunks/DwHuaa1d.js";import{g as sn}from"../chunks/DnK7wyvP.js";import{M as ae}from"../chunks/Bji393O3.js";import{T as It,a as Pt}from"../chunks/CL901LY1.js";import{p as W,i as B}from"../chunks/DSlEI_lp.js";import{c as Te,e as Rt}from"../chunks/DT_pRE8c.js";import{t as Nt,c as an,a as Oe,s as rn}from"../chunks/BJsh87c7.js";import{C as Mt}from"../chunks/B0TzJDWH.js";import{b as ce,s as dt,r as cn}from"../chunks/DGBAUQNC.js";import{a as ct}from"../chunks/BTGG-Xgr.js";import{s as re}from"../chunks/PwPRnE0L.js";import{b as Ie}from"../chunks/C4iwTAZ8.js";import{p as tt,s as Ue}from"../chunks/2t0GVDdd.js";import{a as ln,s as zt,b as xe,c as Ne,D as un}from"../chunks/BPiabKK3.js";import{o as De}from"../chunks/CM252P3v.js";import{s as mt}from"../chunks/Bb4_Y-AM.js";import{a as be}from"../chunks/ZJuK4sHN.js";import{t as pt}from"../chunks/cfbZBCHI.js";import{P as dn}from"../chunks/Dc4r8A7J.js";import{D as mn,b as Re}from"../chunks/Dv-N60ml.js";import{S as _n,g as vn}from"../chunks/BlCDcoTW.js";import{C as hn,T as pn}from"../chunks/DRNI771k.js";import{b as Me}from"../chunks/1Saa3kjD.js";var bt,Et,qt,ue,Be;const de=class de{constructor(t){G(this,ue);G(this,bt,new WeakMap);G(this,Et);G(this,qt);ge(this,qt,t)}observe(t,e){var a=z(this,bt).get(t)||new Set;return a.add(e),z(this,bt).set(t,a),Ee(this,ue,Be).call(this).observe(t,z(this,qt)),()=>{var i=z(this,bt).get(t);i.delete(e),i.size===0&&(z(this,bt).delete(t),z(this,Et).unobserve(t))}}};bt=new WeakMap,Et=new WeakMap,qt=new WeakMap,ue=new WeakSet,Be=function(){return z(this,Et)??ge(this,Et,new ResizeObserver(t=>{for(var e of t){de.entries.set(e.target,e);for(var a of z(this,bt).get(e.target)||[])a(e)}}))},ut(de,"entries",new WeakMap);let $e=de;var fn=new $e({box:"border-box"});function qe(o,t,e){var a=fn.observe(o,()=>e(o[t]));en(()=>(nn(()=>e(o[t])),a))}var gn=E('<span class="font_mono">contextmenu</span> event',1),xn=E('<span class="font_mono">navigator.vibrate</span>'),bn=E('<span class="font_mono">navigator.vibrate</span>'),yn=E(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
