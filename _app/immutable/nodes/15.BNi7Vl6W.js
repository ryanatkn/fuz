var Qe=Object.defineProperty;var Ze=(s,t,e)=>t in s?Qe(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var at=(s,t,e)=>(Ze(s,typeof t!="symbol"?t+"":t,e),e),he=(s,t,e)=>{if(!t.has(s))throw TypeError("Cannot "+e)};var A=(s,t,e)=>(he(s,t,"read from private field"),e?e.call(s):t.get(s)),B=(s,t,e)=>{if(t.has(s))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(s):t.set(s,e)},pe=(s,t,e,a)=>(he(s,t,"write to private field"),a?a.call(s,e):t.set(s,e),e);var Pe=(s,t,e)=>(he(s,t,"access private method"),e);import{a as r,t as d,c as w,s as n,f as h,b as P,l as zt,$ as At}from"../chunks/disclose-version.P6j1kb0M.js";import{h as He,u as Ue,r as K,N as tn,H as O,g as o,t as b,s as be,f as ye,p as dt,a as _t,d as R,K as qt,a6 as M,a4 as Se}from"../chunks/runtime.BNZvPhR8.js";import{i as en}from"../chunks/lifecycle.8yebCWgY.js";import{T as nn}from"../chunks/Tome_Detail.Du0bsHiA.js";import{g as on}from"../chunks/tome.C2gfJtcL.js";import{M as se}from"../chunks/Mdn_Link.BsHN0i9o.js";import{T as Ot}from"../chunks/Tome_Subheading.Bsx9p-Nd.js";import{i as q}from"../chunks/if.B-UrVCq9.js";import{e as Lt}from"../chunks/each.ZGz6eWNW.js";import{t as Dt,a as Ae,c as rn,s as an}from"../chunks/index.DsNDlR1P.js";import{C as Ht}from"../chunks/Code.QBXv6WUh.js";import{d as we,s as st,e as ot,a as It}from"../chunks/render.mpT5_OMu.js";import{p as F}from"../chunks/proxy.CgWesAHI.js";import{s as it,b as le,r as sn,d as cn}from"../chunks/attributes.pzVQFU6X.js";import{s as ie}from"../chunks/style.CN5pMWL6.js";import{b as Ce}from"../chunks/this.Csz6vj9X.js";import{p as Z,s as ze}from"../chunks/props.DlI4434Y.js";import{a as ln,s as Mt,b as fe,c as Oe,D as un}from"../chunks/Dialog.YCS-GJNA.js";import{o as $e}from"../chunks/index-client.BqynBVDZ.js";import{a as ge}from"../chunks/string.ZJuK4sHN.js";import{t as pt}from"../chunks/class.CLuH7Hdx.js";import{P as dn}from"../chunks/Pending_Animation.CjtFUPUs.js";import{D as _n,b as Ne}from"../chunks/Details.C_JqXyx5.js";import{G as mn}from"../chunks/Github_Logo.Cxot-Y7P.js";import{C as vn,T as hn}from"../chunks/Theme_Input.JkO-wAih.js";import{b as Me}from"../chunks/input.WImvOSre.js";function pn(s,t,e){He(()=>{var a=Ue(()=>t(s,e==null?void 0:e())||{});if(e&&(a!=null&&a.update)){var u=!1;K(()=>{var c=e();tn(c),u&&a.update(c)}),u=!0}if(a!=null&&a.destroy)return()=>a.destroy()})}var Tt,Ft,Ut,de,We;const _e=class _e{constructor(t){B(this,de);B(this,Tt,new WeakMap);B(this,Ft,void 0);B(this,Ut,void 0);pe(this,Ut,t)}observe(t,e){var a=A(this,Tt).get(t)||new Set;return a.add(e),A(this,Tt).set(t,a),Pe(this,de,We).call(this).observe(t,A(this,Ut)),()=>{var u=A(this,Tt).get(t);u.delete(e),u.size===0&&(A(this,Tt).delete(t),A(this,Ft).unobserve(t))}}};Tt=new WeakMap,Ft=new WeakMap,Ut=new WeakMap,de=new WeakSet,We=function(){return A(this,Ft)??pe(this,Ft,new ResizeObserver(t=>{for(var e of t){_e.entries.set(e.target,e);for(var a of A(this,Tt).get(e.target)||[])a(e)}}))},at(_e,"entries",new WeakMap);let xe=_e;var fn=new xe({box:"border-box"});function Fe(s,t,e){var a=fn.observe(s,()=>e(s[t]));He(()=>(Ue(()=>e(s[t])),a))}var gn=d('<span class="font_mono">contextmenu</span> event',1),xn=d('<span class="font_mono">navigator.vibrate</span>'),bn=d('<span class="font_mono">navigator.vibrate</span>'),yn=d(`<section><!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
