var Ze=Object.defineProperty;var tn=(s,t,e)=>t in s?Ze(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var ct=(s,t,e)=>(tn(s,typeof t!="symbol"?t+"":t,e),e),he=(s,t,e)=>{if(!t.has(s))throw TypeError("Cannot "+e)};var S=(s,t,e)=>(he(s,t,"read from private field"),e?e.call(s):t.get(s)),V=(s,t,e)=>{if(t.has(s))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(s):t.set(s,e)},pe=(s,t,e,a)=>(he(s,t,"write to private field"),a?a.call(s,e):t.set(s,e),e);var Se=(s,t,e)=>(he(s,t,"access private method"),e);import{a as r,t as u,c as w,s as n,f as p,b as P,l as zt,$ as At}from"../chunks/disclose-version.Ddj0amtR.js";import{h as Ue,u as We,r as G,_ as en,a as Q,p as Z,F as O,g as o,m as b,s as be,f as ye,d as R,V as qt,$ as F}from"../chunks/runtime.N2A2yyIi.js";import{i as we}from"../chunks/lifecycle.B02H3xRw.js";import{T as nn}from"../chunks/Tome_Detail.Ba4p37IF.js";import{g as on}from"../chunks/tome.60teOZbE.js";import{M as se}from"../chunks/Mdn_Link.BdJRFzGf.js";import{T as Ot}from"../chunks/Tome_Subheading.qGdT_lTs.js";import{i as D}from"../chunks/if.UhUuT2rm.js";import{e as Lt}from"../chunks/each.CWSUAFwf.js";import{t as Dt,a as Ae,c as rn,s as an}from"../chunks/index.D0CvV8xx.js";import{C as Ht}from"../chunks/Code.DLdTgamv.js";import{d as Ce,s as lt,e as st,a as It}from"../chunks/render.UwBO_r64.js";import{n as ze}from"../chunks/utils.BSJX-nVd.js";import{s as ut,b as le,r as sn,d as cn}from"../chunks/attributes.aBPS3tII.js";import{s as ie}from"../chunks/style.CN5pMWL6.js";import{b as ke}from"../chunks/this.DR5cQyoW.js";import{p as et,s as Oe}from"../chunks/props.CB8TrldN.js";import{p as M}from"../chunks/proxy.Dw-yJxJX.js";import{a as ln,s as Ft,b as fe,c as $e,D as un}from"../chunks/Dialog.BJ7uh4hk.js";import{o as Ne}from"../chunks/index-client.DX7FO6xG.js";import{a as ge}from"../chunks/string.ZJuK4sHN.js";import{t as pt}from"../chunks/class.BOV0QPCC.js";import{P as dn}from"../chunks/Pending_Animation.mA8_i8BY.js";import{D as _n,b as Fe}from"../chunks/Details.D7hO9GqZ.js";import{G as mn}from"../chunks/Github_Logo.Bg5Cb5mi.js";import{C as vn,T as hn}from"../chunks/Theme_Input.CThZzfiW.js";import{b as Me}from"../chunks/input.BHADLuGw.js";function pn(s,t,e){Ue(()=>{var a=We(()=>t(s,e==null?void 0:e())||{});if(e&&(a!=null&&a.update)){var c=!1;G(()=>{var h=e();en(h),c&&a.update(h)}),c=!0}if(a!=null&&a.destroy)return()=>a.destroy()})}var Tt,Mt,Ut,de,Be;const _e=class _e{constructor(t){V(this,de);V(this,Tt,new WeakMap);V(this,Mt,void 0);V(this,Ut,void 0);pe(this,Ut,t)}observe(t,e){var a=S(this,Tt).get(t)||new Set;return a.add(e),S(this,Tt).set(t,a),Se(this,de,Be).call(this).observe(t,S(this,Ut)),()=>{var c=S(this,Tt).get(t);c.delete(e),c.size===0&&(S(this,Tt).delete(t),S(this,Mt).unobserve(t))}}};Tt=new WeakMap,Mt=new WeakMap,Ut=new WeakMap,de=new WeakSet,Be=function(){return S(this,Mt)??pe(this,Mt,new ResizeObserver(t=>{for(var e of t){_e.entries.set(e.target,e);for(var a of S(this,Tt).get(e.target)||[])a(e)}}))},ct(_e,"entries",new WeakMap);let xe=_e;var fn=new xe({box:"border-box"});function Re(s,t,e){var a=fn.observe(s,()=>e(s[t]));Ue(()=>(We(()=>e(s[t])),a))}var gn=u('<span class="font_mono">contextmenu</span> event',1),xn=u('<span class="font_mono">navigator.vibrate</span>'),bn=u('<span class="font_mono">navigator.vibrate</span>'),yn=u(`<section><!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
