import{b as an,a as o,t as e,f as s,c as a,s as n}from"../chunks/disclose-version.COjBdUkA.js";import{p as rn,a as tn,g as T,v as D,r as $,$ as C}from"../chunks/runtime.BITJpo-a.js";import{s as M,b as A}from"../chunks/render.Z7Ne6upu.js";import{e as j,i as I}from"../chunks/each.Bo18fhyf.js";import{i as _n}from"../chunks/lifecycle.DMmtugz9.js";import{C as x}from"../chunks/Code.CAGfF-1b.js";import{T as on}from"../chunks/Tome_Detail.Bce4-DqK.js";import{T as ln}from"../chunks/Tome_Link.CsfQFrAj.js";import{G as L}from"../chunks/Github_Logo.C6nx6mjp.js";import{g as en}from"../chunks/tome.DbsBumql.js";import{D as R}from"../chunks/Details.DFiI7z7Y.js";import{T as p}from"../chunks/Tome_Subheading.FEImX7Rs.js";const cn=`/* @ryanatkn/fuz/style_utilities.css */
...
`,sn=`/* @ryanatkn/fuz/style_components.css */
...
`;var pn=e('<li class="svelte-1gekuvc"> </li>'),gn=e('<li class="svelte-1gekuvc"> </li>'),dn=e('<span class="font_mono">@ryanatkn/fuz/style_utilities.css</span>'),xn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),vn=e('<span class="font_mono">@ryanatkn/fuz/style_components.css</span>'),mn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),bn=e(`<aside>both the docs and implementation of these need more work</aside> <section><!> <p>Fuz has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Fuz style <!>.</p> <p>Semantic classes are named groupings of styles that are like the CSS equivalent of Svelte
			components.</p> <aside>With more sophisticated build tooling, these classes could be generated on demand instead of
			distributed as static files, or unused classes could be removed with a Vite plugin.</aside></section> <section><!> <p>Fuz provides an arbitrary set of utility classes for CSS, and defers to CSS in <a href="https://svelte.dev/docs/svelte-components#style">Svelte's <code> </code></a> for complex and uncommon patterns.</p> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <!> <!></section>`,1);function An(E,F){tn(F,!1);const P=en("classes"),Y=D(["relative|absolute|fixed|sticky|static","overflow_auto|hidden|scroll|clip|visible","overflow_x|y_auto|hidden|scroll|clip|visible","inline|inline_block|block|flex|grid","display_none|contents","flex_1","box","row","wrap|nowrap","float_none|left|right|inline_start|inline_end","flip_x|y|xy","font_sans|mono","line_height","line_height_xs-xl","size_xs-xl9","icon_size_xs-xl2","text_align_center|right|left|justify","font_weight_100-900","ellipsis","pixelated","text_1-3","darken|lighten_1-9","bg|fg","bg|fg_1-9","color_darken|lighten_1-9","color_bg|fg","color_bg|fg_1-9","hue_a-g","color_a-g_1 -9","bg_a-g_1-9","border_color_1-5","border_width_1-6","outline_width_1-3","border_none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset","radius_0|50|100","radius_xs3-xl","w|h_0|100","w|h_xs-xl15","p|pt|pr|pb|pl|px|py_0","p|pt|pr|pb|pl|px|py_xs5-xl15","m|mx|my_auto","m|mt|mr|mb|ml|mx|my_0","m|mt|mr|mb|ml|mx|my_xs5-xl15","gap_xs5-xl15","row|column_gap_xs5-xl15","fade_0|100","fade_1-6","shadow_md|lg|inset|inset_active"]),q=D(["selectable","pane","panel","icon_button","plain","menu_item","chevron","chip","formatted","width_sm-lg"]);_n();var v=an(),B=s(v);on(B,{tome:P,children:(N,fn)=>{var m=bn(),U=s(m),b=n(n(U,!0)),h=a(b);p(h,{text:"Optional CSS classes",slug:"css-classes"});var V=n(n(h,!0)),f=n(n(V,!0));x(f,{content:`<!-- +layout.svelte -->
<script>
	...
	// ...`});var W=n(n(f,!0)),X=n(a(W));ln(X,{name:"variables"});var u=n(n(b,!0)),w=a(u);p(w,{text:"Utility classes",slug:"utility-classes"});var k=n(n(w,!0)),G=n(a(k)),H=n(a(G)),J=a(H);J.nodeValue="<style>";var K=n(n(k,!0));j(K,9,()=>T(Y),I,(c,r,l)=>{var t=pn(),_=a(t);$(()=>M(_,`.${A(C(r))}`)),o(c,t)});var y=n(n(u,!0)),z=a(y);p(z,{text:"Semantic classes",slug:"semantic-classes"});var Q=n(n(z,!0));j(Q,9,()=>T(q),I,(c,r,l)=>{var t=gn(),_=a(t);$(()=>M(_,`.${A(C(r))}`)),o(c,t)});var Z=n(n(y,!0)),O=a(Z);p(O,{text:"Raw CSS",slug:"raw-css"});var S=n(n(O,!0));R(S,{summary:r=>{var l=dn();o(r,l)},children:(r,l)=>{var t=xn(),_=s(t),i=a(_),g=a(i);L(g,{size:"var(--icon_size_xs)"});var d=n(n(_,!0));x(d,{content:cn,lang:"css"}),o(r,t)}});var nn=n(n(S,!0));R(nn,{summary:r=>{var l=vn();o(r,l)},children:(r,l)=>{var t=mn(),_=s(t),i=a(_),g=a(i);L(g,{size:"var(--icon_size_xs)"});var d=n(n(_,!0));x(d,{content:sn,lang:"css"}),o(r,t)}}),o(N,m)}}),o(E,v),rn()}export{An as component};
