var Ve=Object.defineProperty;var Xe=(a,t,e)=>t in a?Ve(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ut=(a,t,e)=>(Xe(a,typeof t!="symbol"?t+"":t,e),e),me=(a,t,e)=>{if(!t.has(a))throw TypeError("Cannot "+e)};var I=(a,t,e)=>(me(a,t,"read from private field"),e?e.call(a):t.get(a)),U=(a,t,e)=>{if(t.has(a))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(a):t.set(a,e)},ve=(a,t,e,r)=>(me(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e);var Te=(a,t,e)=>(me(a,t,"access private method"),e);import{a as s,t as P,m as be,c as it,k as z,u as Me}from"../chunks/disclose-version.9yIZ7V7W.js";import{o as Ye,u as je,f as N,s as h,c as $,a7 as A,r as y,a8 as E,g as n,J as v,p as vt,t as K,a as ht,d as W,_ as Nt,ax as kt,a6 as ie}from"../chunks/runtime.DjGw2mdp.js";import{T as Ge}from"../chunks/Tome_Content.CPUEDmHe.js";import{g as Ke}from"../chunks/tome.3eVuwvbs.js";import{M as se}from"../chunks/Mdn_Link.peY4zcnJ.js";import{T as Ct,a as Tt}from"../chunks/Tome_Section_Header.beacX_2L.js";import{p as R,i as L}from"../chunks/if.z0eURg79.js";import{c as ye,e as Dt}from"../chunks/context_helpers.B8EeH4yN.js";import{t as Ot,a as Ie,c as Je,s as Ze}from"../chunks/index.DJQ2VRWZ.js";import{C as Rt}from"../chunks/Code.CBXbABPK.js";import{s as dt,c as ce,r as Qe,d as tn}from"../chunks/attributes.CBdo3cfA.js";import{a as ct}from"../chunks/intersect.Bt0ToREf.js";import{s as ae}from"../chunks/style.PwPRnE0L.js";import{b as we}from"../chunks/this.Ckj6gLEd.js";import{p as et,s as Pe}from"../chunks/props.DsbMjey8.js";import{a as en,s as Pt,b as he,c as Se,D as nn}from"../chunks/Dialog.MC9gVkvK.js";import{o as ze}from"../chunks/index-client.grUCS2ma.js";import{s as _t}from"../chunks/render.CJz7DAFC.js";import{a as pe}from"../chunks/string.ZJuK4sHN.js";import{t as ft}from"../chunks/class.C9ZTuVq2.js";import{P as on}from"../chunks/Pending_Animation.DrZGVY8w.js";import{D as sn,b as Ee}from"../chunks/Details.CPOGtgva.js";import{S as an,g as rn}from"../chunks/logos.DgYyikgF.js";import{C as cn,T as ln}from"../chunks/Theme_Input.BeVvGhLv.js";import{b as Ae}from"../chunks/input.ZvFC_7MC.js";var yt,St,Mt,ue,qe;const de=class de{constructor(t){U(this,ue);U(this,yt,new WeakMap);U(this,St,void 0);U(this,Mt,void 0);ve(this,Mt,t)}observe(t,e){var r=I(this,yt).get(t)||new Set;return r.add(e),I(this,yt).set(t,r),Te(this,ue,qe).call(this).observe(t,I(this,Mt)),()=>{var o=I(this,yt).get(t);o.delete(e),o.size===0&&(I(this,yt).delete(t),I(this,St).unobserve(t))}}};yt=new WeakMap,St=new WeakMap,Mt=new WeakMap,ue=new WeakSet,qe=function(){return I(this,St)??ve(this,St,new ResizeObserver(t=>{for(var e of t){de.entries.set(e.target,e);for(var r of I(this,yt).get(e.target)||[])r(e)}}))},ut(de,"entries",new WeakMap);let ge=de;var un=new ge({box:"border-box"});function Oe(a,t,e){var r=un.observe(a,()=>e(a[t]));Ye(()=>(je(()=>e(a[t])),r))}var dn=P('<span class="font_mono">contextmenu</span> event',1),_n=P('<span class="font_mono">navigator.vibrate</span>'),mn=P('<span class="font_mono">navigator.vibrate</span>'),vn=P(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
