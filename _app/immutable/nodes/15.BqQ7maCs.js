var Ge=Object.defineProperty;var je=(a,t,e)=>t in a?Ge(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ut=(a,t,e)=>(je(a,typeof t!="symbol"?t+"":t,e),e),_e=(a,t,e)=>{if(!t.has(a))throw TypeError("Cannot "+e)};var I=(a,t,e)=>(_e(a,t,"read from private field"),e?e.call(a):t.get(a)),W=(a,t,e)=>{if(t.has(a))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(a):t.set(a,e)},me=(a,t,e,r)=>(_e(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e);var Ce=(a,t,e)=>(_e(a,t,"access private method"),e);import{a as s,t as P,l as fe,c as it,g as S,p as De}from"../chunks/disclose-version.7b59C0PR.js";import{q as Je,u as Qe,f as O,s as h,c as $,an as z,r as y,ao as A,g as n,E as v,l as ge,m as xe,p as vt,t as j,a as ht,d as U,ah as Nt,as as kt,am as ie}from"../chunks/runtime.TFn0e1ji.js";import{T as Ze}from"../chunks/Tome_Content.aHDdZoF9.js";import{g as tn}from"../chunks/tome.D0gm-ZJ6.js";import{M as se}from"../chunks/Mdn_Link.CmFYeVJF.js";import{T as Ct,a as Tt}from"../chunks/Tome_Section_Header.zEHgdRce.js";import{i as q}from"../chunks/if.BCWWcCm1.js";import{e as Ft}from"../chunks/each.GerYceBW.js";import{t as Ot,a as Te,c as en,s as nn}from"../chunks/index.BexeALvm.js";import{C as Mt}from"../chunks/Code.B3qo1_p1.js";import{s as dt,c as ce,r as on,e as sn}from"../chunks/attributes.BZkAnuRC.js";import{a as ct}from"../chunks/intersect.DlPIx6_6.js";import{s as ae}from"../chunks/style.Bk7ejTAN.js";import{p as M}from"../chunks/proxy.D6d6jnBM.js";import{b as be}from"../chunks/this.ajt3TWDz.js";import{p as et,s as Ie}from"../chunks/props.DGMTMomc.js";import{a as an,s as Pt,b as ve,c as Pe,D as rn}from"../chunks/Dialog.BxUM2PZE.js";import{o as Ee}from"../chunks/index-client.D2e0pCKO.js";import{s as _t}from"../chunks/render.CfaAti5L.js";import{a as he}from"../chunks/string.ZJuK4sHN.js";import{t as ft}from"../chunks/class.D7hBhbh-.js";import{P as cn}from"../chunks/Pending_Animation.J2ubzJ1U.js";import{D as ln,b as Se}from"../chunks/Details.DJ-g8KGN.js";import{G as un}from"../chunks/Github_Logo.B3Bm6bUX.js";import{C as dn,T as _n}from"../chunks/Theme_Input.CfgCkufH.js";import{b as Ae}from"../chunks/input.QdksHISh.js";var yt,Et,Dt,ue,Re;const de=class de{constructor(t){W(this,ue);W(this,yt,new WeakMap);W(this,Et,void 0);W(this,Dt,void 0);me(this,Dt,t)}observe(t,e){var r=I(this,yt).get(t)||new Set;return r.add(e),I(this,yt).set(t,r),Ce(this,ue,Re).call(this).observe(t,I(this,Dt)),()=>{var o=I(this,yt).get(t);o.delete(e),o.size===0&&(I(this,yt).delete(t),I(this,Et).unobserve(t))}}};yt=new WeakMap,Et=new WeakMap,Dt=new WeakMap,ue=new WeakSet,Re=function(){return I(this,Et)??me(this,Et,new ResizeObserver(t=>{for(var e of t){de.entries.set(e.target,e);for(var r of I(this,yt).get(e.target)||[])r(e)}}))},ut(de,"entries",new WeakMap);let pe=de;var mn=new pe({box:"border-box"});function ze(a,t,e){var r=mn.observe(a,()=>e(a[t]));Je(()=>(Qe(()=>e(a[t])),r))}var vn=P('<span class="font_mono">contextmenu</span> event',1),hn=P('<span class="font_mono">navigator.vibrate</span>'),pn=P('<span class="font_mono">navigator.vibrate</span>'),fn=P(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
...
</Contextmenu_Root>`}),z(6),y(p),s(r,u)},$$slots:{default:!0}})},$$slots:{default:!0}})}var Po=P("<section><aside><p>todo: demonstrate using <code>contextmenu_action</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section> <!> <!> <!> <!> <!> <!>",1);function ns(a,t){vt(t,!0);const r=tn("Contextmenu");Ze(a,{tome:r,children:(o,u)=>{var i=Po(),p=h(O(i),2);fo(p);var b=h(p,2);Io(b);var C=h(b,2);yo(C);var x=h(C,2);Co(x);var d=h(x,2);mo(d,{});var f=h(d,2);bn(f),s(o,i)},$$slots:{default:!0}}),ht()}export{ns as component};
