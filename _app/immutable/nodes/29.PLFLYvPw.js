import"../chunks/DsnmJJEf.js";import{p as Pe,c as Te,f as u,a as v,a9 as F,b as r,s as e,d as s,aj as n,r as t,i as M,u as qe,t as ie,e as L,g as Y}from"../chunks/DxN3B-L-.js";import{g as ce}from"../chunks/aN8nENvo.js";import{i as N}from"../chunks/MU3_SrQd.js";import{C as q}from"../chunks/DzUQ2yVy.js";import{G as le}from"../chunks/Ci5Q1T4r.js";import{g as Ae}from"../chunks/D-iDhrCz.js";import{T as ze}from"../chunks/DVPXuMM8.js";import{M as ne}from"../chunks/CGu-reRY.js";import{T as O,a as R}from"../chunks/CsVlJhdM.js";import{I as y}from"../chunks/C3EjYv6G.js";const Ie=["low","medium","high"],Ee={"default-src":null,"script-src":"high","script-src-elem":"high","script-src-attr":null,"style-src":"medium","style-src-elem":"medium","style-src-attr":"medium","img-src":"low","media-src":"low","font-src":"low","manifest-src":null,"child-src":null,"connect-src":"medium","frame-src":"medium","frame-ancestors":"medium","form-action":"medium","worker-src":"medium","object-src":null,"base-uri":null,"upgrade-insecure-requests":null,"report-to":null,"require-trusted-types-for":null,"trusted-types":null,sandbox:null},de=[{name:"default-src",fallback:null,fallback_of:["script-src","script-src-elem","script-src-attr","style-src","style-src-elem","style-src-attr","img-src","media-src","font-src","manifest-src","child-src","connect-src","worker-src","object-src"]},{name:"script-src",fallback:["default-src"],fallback_of:["script-src-elem","script-src-attr","worker-src"]},{name:"script-src-elem",fallback:["script-src","default-src"],fallback_of:null},{name:"script-src-attr",fallback:["script-src","default-src"],fallback_of:null},{name:"style-src",fallback:["default-src"],fallback_of:["style-src-elem","style-src-attr"]},{name:"style-src-elem",fallback:["style-src","default-src"],fallback_of:null},{name:"style-src-attr",fallback:["style-src","default-src"],fallback_of:null},{name:"img-src",fallback:["default-src"],fallback_of:null},{name:"media-src",fallback:["default-src"],fallback_of:null},{name:"font-src",fallback:["default-src"],fallback_of:null},{name:"manifest-src",fallback:["default-src"],fallback_of:null},{name:"child-src",fallback:["default-src"],fallback_of:["frame-src","worker-src"]},{name:"connect-src",fallback:["default-src"],fallback_of:null},{name:"frame-src",fallback:["child-src"],fallback_of:null},{name:"frame-ancestors",fallback:null,fallback_of:null},{name:"form-action",fallback:null,fallback_of:null},{name:"worker-src",fallback:["child-src","script-src","default-src"],fallback_of:null},{name:"object-src",fallback:["default-src"],fallback_of:null},{name:"base-uri",fallback:null,fallback_of:null},{name:"upgrade-insecure-requests",fallback:null,fallback_of:null},{name:"report-to",fallback:null,fallback_of:null},{name:"require-trusted-types-for",fallback:null,fallback_of:null},{name:"trusted-types",fallback:null,fallback_of:null},{name:"sandbox",fallback:null,fallback_of:null}];new Map(de.map(o=>[o.name,o]));const H=o=>{if(o===null)return"null";if(o===void 0)return"undefined";const g=typeof o;return g==="string"?`'${o}'`:g==="number"||g==="boolean"?o+"":Array.isArray(o)?`[${o.map(H).join(", ")}]`:g==="object"?JSON.stringify(o):o+""};var je=u("<td>No trust - used for directives that don't support sources</td>"),Fe=u("<td>Passive resources only - no script execution, no styling or UI control</td>"),Me=u(`<td>Content that may affect layout, styling, or embed external browsing contexts, but
		...
		levels. Some details may change and input is welcome.</aside>`,1);function at(o,g){Pe(g,!0);const ue=Ae("csp");ze(o,{get tome(){return ue},children:(fe,Ye)=>{var J=Ue(),B=v(J),D=s(B),K=e(s(D),3);ne(K,{path:"https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/ContentSecurityPolicy",children:(c,k)=>{n();var a=F("Content Security Policies");r(c,a)},$$slots:{default:!0}});var pe=e(K,2);y(pe,{name:"create_csp_directives"}),n(),t(D);var Q=e(D,6);q(Q,{content:`import {create_csp_directives, type CspSourceSpec} from '@ryanatkn/fuz/csp.js';
...
});`,lang:"ts"});var V=e(Q,4),me=e(s(V));y(me,{name:"CspTrustLevel"}),n(),t(V),n(2),t(B);var X=e(B,2);O(X,{children:(c,k)=>{var a=Oe(),d=v(a);R(d,{text:"Trust"});var i=e(d,2),p=e(s(i));y(p,{name:"CspTrustLevel"}),n(),t(i);var w=e(i,2);q(w,{content:`export const my_csp_trusted_sources: Array<CspSourceSpec> = [
...
];`});var _=e(w,2),x=s(_),m=s(x),h=e(s(m),2),b=e(s(h));y(b,{name:"required_trust_defaults_base"}),t(h),t(m),t(x);var S=e(x);ce(S,20,()=>[null].concat(Ie),A=>A,(A,f)=>{var z=Ne(),$=s(z),G=s($);{let l=qe(()=>H(f));q(G,{get content(){return M(l)}})}t($);var I=e($);{var U=l=>{var C=je();r(l,C)},_e=l=>{var C=Y(),be=v(C);{var ye=P=>{var E=Fe();r(P,E)},ge=P=>{var E=Y(),ke=v(E);{var we=T=>{var j=Me();r(T,j)},xe=T=>{var j=Y(),Se=v(j);{var $e=W=>{var Ce=Le();r(W,Ce)};N(Se,W=>{f==="high"&&W($e)},!0)}r(T,j)};N(ke,T=>{f==="medium"?T(we):T(xe,!1)},!0)}r(P,E)};N(be,P=>{f==="low"?P(ye):P(ge,!1)},!0)}r(l,C)};N(I,l=>{f===null?l(U):l(_e,!1)})}var ae=e(I),oe=s(ae),he=s(oe,!0);t(oe),t(ae),t(z),ie(l=>L(he,l),[()=>Object.entries(Ee).filter(([l,C])=>C===f).map(([l])=>H(l)).join(", ")]),r(A,z)}),t(S),t(_),n(2),r(c,a)},$$slots:{default:!0}});var Z=e(X,2);O(Z,{children:(c,k)=>{var a=Re(),d=v(a);R(d,{text:"Explicit directives"});var i=e(d,4);q(i,{content:`export const my_csp_trusted_sources: Array<CspSourceSpec> = [
...
];`,lang:"ts"}),r(c,a)},$$slots:{default:!0}});var ee=e(Z,2);O(ee,{children:(c,k)=>{var a=Be(),d=v(a);R(d,{text:"Base defaults"});var i=e(d,2),p=e(s(i),3);y(p,{name:"csp_directive_value_defaults"});var w=e(p,4);y(w,{name:"csp_directive_required_trust_defaults"}),n(),t(i);var _=e(i,2);q(_,{content:`// Start with completely empty defaults (fully declarative):
...
});`,lang:"ts"}),r(c,a)},$$slots:{default:!0}});var te=e(ee,2);O(te,{children:(c,k)=>{var a=Ge(),d=v(a);R(d,{text:"Directive specs"});var i=e(d,2),p=e(s(i));y(p,{name:"csp_directive_specs"});var w=e(p,2);ne(w,{path:"Web/HTTP/Reference/Headers/Content-Security-Policy",children:(m,h)=>{n();var b=F("CSP directives");r(m,b)},$$slots:{default:!0}}),n(),t(i);var _=e(i,2),x=e(s(_));ce(x,21,()=>de,m=>m.name,(m,h)=>{var b=De(),S=s(b),A=s(S,!0);t(S);var f=e(S),z=s(f,!0);t(f);var $=e(f),G=s($,!0);t($),t(b),ie((I,U)=>{L(A,M(h).name),L(z,I),L(G,U)},[()=>M(h).fallback?.join(", ")||"",()=>M(h).fallback_of?.join(", ")||""]),r(m,b)}),t(x),t(_),r(c,a)},$$slots:{default:!0}});var se=e(te,2),re=e(s(se));le(re,{path:"ryanatkn/fuz/blob/main/src/lib/csp.ts",children:(c,k)=>{n();var a=F("source code");r(c,a)},$$slots:{default:!0}});var ve=e(re,2);le(ve,{path:"ryanatkn/fuz/blob/main/src/lib/csp.test.ts",children:(c,k)=>{n();var a=F("tests");r(c,a)},$$slots:{default:!0}}),n(),t(se),r(fe,J)},$$slots:{default:!0}}),Te()}export{at as component};
