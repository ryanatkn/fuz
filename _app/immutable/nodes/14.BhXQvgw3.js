var Ke=Object.defineProperty;var ze=o=>{throw TypeError(o)};var Ze=(o,t,e)=>t in o?Ke(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var lt=(o,t,e)=>Ze(o,typeof t!="symbol"?t+"":t,e),pe=(o,t,e)=>t.has(o)||ze("Cannot "+e);var z=(o,t,e)=>(pe(o,t,"read from private field"),e?e.call(o):t.get(o)),Y=(o,t,e)=>t.has(o)?ze("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(o):t.set(o,e),fe=(o,t,e,a)=>(pe(o,t,"write to private field"),a?a.call(o,e):t.set(o,e),e),Ee=(o,t,e)=>(pe(o,t,"access private method"),e);import{t as E,a as s,k as Ce,j as O,c as ft,m as We,y as Je,z as Qe}from"../chunks/CV4FwyaA.js";import{k as tn,j as en,f as U,s as v,Z as $,a3 as q,_ as y,a5 as D,g as n,O as m,N as Nt,p as mt,X as nt,u as V,a as vt,m as Dt,aq as Pt,a2 as ue}from"../chunks/D0mNtKt1.js";import{T as nn}from"../chunks/CADY2tVd.js";import{g as on}from"../chunks/CJ_0K_ee.js";import{M as se}from"../chunks/BpaxWoAN.js";import{T as St,a as At}from"../chunks/Ch5h8-xW.js";import{i as B}from"../chunks/DLPlRC8e.js";import{c as Te,e as qt}from"../chunks/CoNyNLDF.js";import{t as Ot,c as sn,a as Oe,s as an}from"../chunks/q83dzWF7.js";import{C as Mt}from"../chunks/B5JwzsMJ.js";import{b as re,s as ut,c as gt,d as we,r as rn}from"../chunks/nLiBoCGh.js";import{a as ct}from"../chunks/B3xrczOP.js";import{b as Ie}from"../chunks/CYoBXgdV.js";import{p as ot,s as Ue}from"../chunks/BonTfi2d.js";import{a as cn,s as zt,b as ge,c as Ne,D as ln}from"../chunks/BEC-22vd.js";import{o as De}from"../chunks/DYBLuwFO.js";import{s as dt}from"../chunks/TnscAVDV.js";import{a as xe}from"../chunks/ZJuK4sHN.js";import{P as un}from"../chunks/BNX9-L-_.js";import{D as dn,b as qe}from"../chunks/DJdwhidV.js";import{S as _n,g as mn}from"../chunks/Cdlpzfge.js";import{C as vn,T as hn}from"../chunks/CgWohdzB.js";import{b as Me}from"../chunks/B2BNxo9l.js";var Ct,Et,Rt,ce,Be;const le=class le{constructor(t){Y(this,ce);Y(this,Ct,new WeakMap);Y(this,Et);Y(this,Rt);fe(this,Rt,t)}observe(t,e){var a=z(this,Ct).get(t)||new Set;return a.add(e),z(this,Ct).set(t,a),Ee(this,ce,Be).call(this).observe(t,z(this,Rt)),()=>{var c=z(this,Ct).get(t);c.delete(e),c.size===0&&(z(this,Ct).delete(t),z(this,Et).unobserve(t))}}};Ct=new WeakMap,Et=new WeakMap,Rt=new WeakMap,ce=new WeakSet,Be=function(){return z(this,Et)??fe(this,Et,new ResizeObserver(t=>{for(var e of t){le.entries.set(e.target,e);for(var a of z(this,Ct).get(e.target)||[])a(e)}}))},lt(le,"entries",new WeakMap);let $e=le;var pn=new $e({box:"border-box"});function Re(o,t,e){var a=pn.observe(o,()=>e(o[t]));tn(()=>(en(()=>e(o[t])),a))}var fn=E('<span class="font_mono">contextmenu</span> event',1),gn=E('<span class="font_mono">navigator.vibrate</span>'),xn=E('<span class="font_mono">navigator.vibrate</span>'),bn=E(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
