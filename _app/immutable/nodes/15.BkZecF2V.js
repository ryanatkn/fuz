var Ve=Object.defineProperty;var Xe=(a,t,e)=>t in a?Ve(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var ut=(a,t,e)=>(Xe(a,typeof t!="symbol"?t+"":t,e),e),me=(a,t,e)=>{if(!t.has(a))throw TypeError("Cannot "+e)};var I=(a,t,e)=>(me(a,t,"read from private field"),e?e.call(a):t.get(a)),U=(a,t,e)=>{if(t.has(a))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(a):t.set(a,e)},ve=(a,t,e,r)=>(me(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e);var Te=(a,t,e)=>(me(a,t,"access private method"),e);import{a as s,t as P,l as be,c as it,g as z,p as Me}from"../chunks/disclose-version.ZoaYz1AU.js";import{o as Ye,u as je,f as N,s as h,c as $,a4 as A,r as y,a5 as E,g as n,J as v,p as vt,t as K,a as ht,d as W,X as Nt,at as kt,a3 as ie}from"../chunks/runtime.DaB_8cOj.js";import{T as Ge}from"../chunks/Tome_Content.daSAKTT3.js";import{g as Ke}from"../chunks/tome.DeIcXbwy.js";import{M as se}from"../chunks/Mdn_Link.D0ZrQ25x.js";import{T as Ct,a as Tt}from"../chunks/Tome_Section_Header.Bgwtr0Va.js";import{p as R,i as L}from"../chunks/if.BRCK-0uq.js";import{c as ye,e as Dt}from"../chunks/context_helpers.B8hPR0aD.js";import{t as Ot,a as Ie,c as Je,s as Ze}from"../chunks/index.Bt4uqa_Y.js";import{C as Rt}from"../chunks/Code.DozXpeGJ.js";import{s as dt,c as ce,r as Qe,d as tn}from"../chunks/attributes.BPvofiUC.js";import{a as ct}from"../chunks/intersect.BjZoTFN6.js";import{s as ae}from"../chunks/style.Bk7ejTAN.js";import{b as we}from"../chunks/this.D5gY84Ht.js";import{p as et,s as Pe}from"../chunks/props.tfL6ot4I.js";import{a as en,s as Pt,b as he,c as Se,D as nn}from"../chunks/Dialog.D5ffDNx3.js";import{o as ze}from"../chunks/index-client.08JWXHmx.js";import{s as _t}from"../chunks/render.DpEwyGnv.js";import{a as pe}from"../chunks/string.ZJuK4sHN.js";import{t as ft}from"../chunks/class.CbbrPzi3.js";import{P as on}from"../chunks/Pending_Animation.DWdgyn_J.js";import{D as sn,b as Ee}from"../chunks/Details.DU11toQk.js";import{S as an,g as rn}from"../chunks/logos.DDXGBnOE.js";import{C as cn,T as ln}from"../chunks/Theme_Input.BRhrJ3BR.js";import{b as Ae}from"../chunks/input.D42hkQiW.js";var yt,St,Mt,ue,qe;const de=class de{constructor(t){U(this,ue);U(this,yt,new WeakMap);U(this,St,void 0);U(this,Mt,void 0);ve(this,Mt,t)}observe(t,e){var r=I(this,yt).get(t)||new Set;return r.add(e),I(this,yt).set(t,r),Te(this,ue,qe).call(this).observe(t,I(this,Mt)),()=>{var o=I(this,yt).get(t);o.delete(e),o.size===0&&(I(this,yt).delete(t),I(this,St).unobserve(t))}}};yt=new WeakMap,St=new WeakMap,Mt=new WeakMap,ue=new WeakSet,qe=function(){return I(this,St)??ve(this,St,new ResizeObserver(t=>{for(var e of t){de.entries.set(e.target,e);for(var r of I(this,yt).get(e.target)||[])r(e)}}))},ut(de,"entries",new WeakMap);let ge=de;var un=new ge({box:"border-box"});function Oe(a,t,e){var r=un.observe(a,()=>e(a[t]));Ye(()=>(je(()=>e(a[t])),r))}var dn=P('<span class="font_mono">contextmenu</span> event',1),_n=P('<span class="font_mono">navigator.vibrate</span>'),mn=P('<span class="font_mono">navigator.vibrate</span>'),vn=P(`<!> <p>The <code>Contextmenu</code> overrides the system contextmenu to provide capabilities specific
