import{t as l,a as e,j as D}from"../chunks/DoRN4M-o.js";import{p as F,a as G,f as m,k as b,s as r,a2 as o,l as C}from"../chunks/CLNC1iHR.js";import{b as P}from"../chunks/B4ZId5iA.js";import{C as c}from"../chunks/DeLZ0-Bp.js";import{g as J}from"../chunks/Cmf78iW_.js";import{C as v}from"../chunks/B5IFMA17.js";import{T as K}from"../chunks/DRS3UrDn.js";import{T as u,a as g}from"../chunks/BDlH6bgp.js";var O=l("just<br> a card",1),Q=l("custom<br> icon",1),U=l("<!> <!> <!>",1),V=l("a<br> link",1),X=l("<!> <!> <!>",1),Z=l("href is<br> selected",1),rr=l("<!> <!> <!>",1),tr=l("custom<br> tag",1),or=l("<!> <!> <!>",1),ar=l("align<br> icon right",1),er=l("<!> <!> <!>",1),nr=l("align<br> icon above",1),sr=l("align<br> icon below",1),lr=l("<section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function pr(W,B){F(B,!0);const H=J("Card"),x=`${P}/library`;K(W,{tome:H,children:(N,ir)=>{var T=lr(),p=m(T),k=b(p);c(k,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var A=r(k,2);c(A,{content:`<Card>
  just<br />
  a card
