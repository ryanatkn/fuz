import"../chunks/DsnmJJEf.js";import{p as G,c as J,f as d,s as r,a as f,d as C,b as a,ar as e,r as P,aq as K,h as x,u as T}from"../chunks/hvi78P_d.js";import{r as A}from"../chunks/CM82E11j.js";import{C as _}from"../chunks/BK81am7X.js";import{g as O}from"../chunks/BTXkAjpf.js";import{C as $}from"../chunks/AC9THJc2.js";import{T as Q}from"../chunks/khqPeQO5.js";import{T as m,a as g}from"../chunks/tpTUo5Wk.js";var U=d("just<br/> a card",1),V=d("custom<br/> icon",1),X=d("<!> <!> <!>",1),Z=d("a<br/> link",1),rr=d("<!> <!> <!>",1),tr=d("href is<br/> selected",1),er=d("<!> <!> <!>",1),or=d("custom<br/> tag",1),ar=d("<!> <!> <!>",1),nr=d("align<br/> icon right",1),sr=d("<!> <!> <!>",1),dr=d("align<br/> icon above",1),lr=d("align<br/> icon below",1),ir=d("<section><aside>⚠️ This API is unfinished and will likely change.</aside></section> <section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function br(N,S){G(S,!0);const Y=O("Card"),k=A("/docs");Q(N,{get tome(){return Y},children:(q,_r)=>{var w=ir(),h=r(f(w),2),I=C(h);_(I,{content:"import Card from '@ryanatkn/fuz/Card.svelte';",lang:"ts"});var M=r(I,2);_(M,{content:`<Card>
  just<br />
  a card
</Card>`});var z=r(M,2);$(z,{children:(o,u)=>{e();var t=U();e(2),a(o,t)},$$slots:{default:!0}}),P(h);var E=r(h,2);m(E,{children:(o,u)=>{var t=X(),n=f(t);g(n,{text:"With a custom icon"});var s=r(n,2);_(s,{content:`<Card>
  custom<br />
  icon
  ...
  align<br />
  icon below
</Card>`});var F=r(H,2);$(F,{align:"below",children:(o,u)=>{e();var t=lr();e(2),a(o,t)},$$slots:{default:!0}}),P(B),a(q,w)},$$slots:{default:!0}}),J()}export{br as component};
